...
<body>
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-1" class="container">
			...
			<form:form id="reservationAutoDataForm"
				name="reservationAutoDataForm"
				...
				<c:choose>
					<c:when test="${tdmPolicyAutoSearchResultDTOList ne null}">
						...
						<div id="tabs-1" class="container scrollingX">
							<table class="table outputtable tablesorter"
						...
						<ul class="grdPagination">
							<%
											...
											if (currentPage != 1) {
			   							%>
							<li><a href="myReservationAuto?page=<%= 1 %>">First</a>
							<div>First</div></li>
							<li><a href="myReservationAuto?page=<%= currentPage-1 %>">&lt;
									Prev</a>
							<div>&lt; Prev</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
							<li class="disable"><a
								href="myReservationAuto?page=<%= 1 %>">First</a>
							<div>First</div></li>
							<li class="disable"><a
								href="myReservationAuto?page=<%= currentPage-1 %>">&lt; Prev</a>
							<div>&lt; Prev</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
							...
							<%
			    						...
			    						%>
							<li><a href="myReservationAuto?page=<%= i %>"
								id="employeeLink"><%= i %></a>
							<div><%= i %></div></li>
							<%
			    									}
										...
										%>
							<li><a href="myReservationAuto?page=<%= currentPage+1 %>">Next
									&gt;</a>
							<div>Next &gt;</div></li>
							<li><a href="myReservationAuto?page=<%= noOfPages %>">Last</a>
							<div>Last</div></li>
							<%
											} else {
											    if(noOfPages > 1) {
										%>
							<li class="disable"><a
								href="myReservationAuto?page=<%= currentPage+1 %>">Next &gt;</a>
							<div>Next &gt;</div></li>
							<li class="disable"><a
								href="myReservationAuto?page=<%= noOfPages %>">Last</a>
							<div>Last</div></li>
							<%
											    }
											}
							...
							<tbody>
								<tr>
									<th scope="col"><input type="button" name="back" id="back"
										...
										class="btn-primary btn-cell" value="Export All to Excel">
									</th>
								</tr>
							</tbody>
						</table>
