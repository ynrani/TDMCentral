...
<body>
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-1" class="container">
			<form:form id="policySearchForm" name="policySearchForm"
				action="${pageContext.request.contextPath}/policySearch"
				modelAttribute="tdmPolicySearchDTO">
				<div class="">
					...
					<table
						...
						<tbody>
							...
							<tr>
								...
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.policy.poilcyNum" /></td>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.policy.faceAmt" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="faceAmt" id="faceAmt" class="form-control"
										maxlength="21" /></td>
								<td class="lable-title" align="left" valign="middle" scope="col">
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="insuFirstName" id="insuFirstName"
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="insuLastName" id="insuLastName"
										class="form-control" maxlength="21" />
								</td>
								...
								<td class="flied-title" class="flied-title" align="left"
									...
									class="radio-inline"> <form:radiobutton path="gender"
										...
										<spring:message code="label.female" />
											...
											path="gender" id="gender" value="Both" /> Any
								</label></td>

								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.policy.dob" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="dob" id="dob" class="date-control datepicker from" />
								</td>
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="distChnl" id="distChnl" class="form-control "
										maxlength="21" />
								</td>

								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.policy.agentId" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
						...
						<tbody>
							<tr>
								<td colspan="4" align="center" valign="middle"><input
									...
									onClick="clearFields('./policySearch');" /></td>
							</tr>
						</tbody>
					</table>
				...
				<c:if test="${tdmPolicySearchDTO.tdmPolicySearchResultDTOs eq null}">
					...
					<c:if test="${result ne null}">
						...
						<c:if
							test="${tdmPolicySearchDTO.autoEmailDTOs ne null && empty tdmPolicySearchDTO.autoEmailDTOs && reserveFlag eq null}">
						...
						<c:if
							test="${tdmPolicySearchDTO.autoEmailDTOs ne null &&  not empty tdmPolicySearchDTO.autoEmailDTOs && reserveFlag eq null}">
							...
							<table class="table "
								...
								<tbody>
									<c:forEach items="${tdmPolicySearchDTO.autoEmailDTOs}"
...
<%--							<ul class="grdPagination">
 								<%
											...
											if (currentPage != 1) {
			   							%>
								<li><a href="policySearch?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li><a href="policySearch?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
								<li class="disable"><a href="policySearch?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li class="disable"><a
									href="policySearch?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
								...
								<%
			    						...
			    						%>
								<li><a href="policySearch?page=<%= i %>" id="employeeLink"><%= i %></a>
								<div><%= i %></div></li>
								<%
			    									}
			    								}
								...
								<li><a href="policySearch?page=<%= currentPage+1 %>">&gt;</a>
								<div>&gt;</div></li>
								<li><a href="policySearch?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											} else {
											    if(noOfPages > 1) {
								...
								<div>&gt;</div></li>
								<li class="disable"><a
									href="policySearch?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											    }
											}
						...
						<c:if
							test="${tdmPolicySearchDTO.autoEmailDTOs eq null && empty tdmPolicySearchDTO.autoEmailDTOs}">
				...
				<c:if
					test="${tdmPolicySearchDTO.tdmPolicySearchResultDTOs ne null &&  not empty tdmPolicySearchDTO.tdmPolicySearchResultDTOs}">
					<%
									int currentPage = (Integer) request.getAttribute("currentPage");
									int count1 = currentPage - 1;
									count1 = count1 * 10;
					...
					<div class="scrollingX" id="myid">
						<table id="search_output_table" class="table tablesorter"
							...
							<thead>
								<tr>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="lebel.chkb" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.policyNo" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.comp" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.prodName" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
									...
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.ssn" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.gender" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.dob" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.distChnl" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.agentId" /></th>
							...
							<tbody>
								<c:forEach
									items="${tdmPolicySearchDTO.tdmPolicySearchResultDTOs}"
									...
									<tr>
										<c:if test="${tdmPolicySearchResultDTOs.reservedYN eq null }">
											<td><label class="checkbox-inline"> <form:checkbox
														path="tdmPolicySearchResultDTOs[${status.index}].reservedYN"
														id="tdmPolicySearchResultDTOs[${status.index}].reservedYN"
								...
								<c:forEach
									...
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].policyNo" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].productName" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].companyName" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].faceAmt" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].productType" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].fristName" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].lastName" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].ssn" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].gender" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].dob" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].distChnal" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].agentId" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].riders" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].benefits" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].owner" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].beneficiary" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].paymentMethod" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].paymentMode" />


									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].testCaseId" />
									<form:hidden
										path="tdmPolicySearchResultDTOs[${status.index}].testCaseName" />
								</c:forEach>
							</tbody>
						</table>
					</div>
