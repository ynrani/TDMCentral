...
<body>
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-2" class="container">
			...
			<form:form id="testDataFormClaim" name="testDataFormClaim"
				class="testval"
				action="${pageContext.request.contextPath}/testdaClaimUser"
				modelAttribute="tDMClaimSearchDTO">
				<table
					...
					<tbody>
						...
						<tr>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.modifier" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="claimModifier" id="claimModifier" class="form-control"
									maxlength="10" /></td>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.source" /></td>
							<td class="flied-title" align="left" valign="middle"><form:select
									path="claimSource" id="claimSource" class="down-control">
									<form:option value="">All</form:option>
									<c:forEach items="${tDMClaimSearchDTO.tdmClaimSrcDTOs}"
										var="tdmClaimSrcDTOs">
						...
						<tr>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.claimProviderTIN" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="claimProviderTIN" id="claimProviderTIN"
									class="form-control" maxlength="10" /></td>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.provider.NPI" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="claimProviderNPI" id="claimProviderNPI"
									class="form-control" maxlength="11" /></td>
						</tr>
						<tr>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.pos" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<form:select path="claimPOS" id="claimPOS" class="down-control">
									<form:option value="">All</form:option>
									<c:forEach items="${tDMClaimSearchDTO.tdmClaimPOSMastDTOs}"
										var="tdmClaimPOSMastDTOs">
										<form:option value="${tdmClaimPOSMastDTOs.claimPOSDesc}">${tdmClaimPOSMastDTOs.claimPOSDesc}</form:option>
									</c:forEach>
								</form:select>
							</td>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.type" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<form:select path="claimType" id="claimType"
									class="down-control">
									<form:option value="">All</form:option>
									<c:forEach items="${tDMClaimSearchDTO.tdmClaimTypeMastDTOs}"
										var="tdmClaimTypeMastDTOs">
						...
						<tr>
							...
							<td class="flied-title" align="left" valign="middle"><form:select
									...
									<form:option value="">All</form:option>
									<c:forEach items="${tDMClaimSearchDTO.tdmClaimStatusMastDTOs}"
						...
						<tr>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.typOfService" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="claimServiceType" id="claimServiceType"
									class="form-control" /></td>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.gender" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<label class="radio-inline"> <form:radiobutton
										path="claimGender" id="claimGender" value="Male" />
									<spring:message code="label.male" /></label> <label
								class="radio-inline"> <form:radiobutton
										path="claimGender" id="claimGender" value="Female" />
									<spring:message code="label.female" />
							</label> <label class="radio-inline"> <form:radiobutton
										path="claimGender" id="gender" value="Both" />
					...
					<tbody id="disOnFacilityClaimType">
						<tr>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.revenueCode" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="claimRevCode" id="claimRevCode" class="form-control"
									maxlength="21" /></td>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.typeOfBill" /></td>
							<td class="flied-title" align="left" valign="middle"><form:select
									path="typeOfBill" id="typeOfBill" class="down-control">
									<form:option value="">All</form:option>
									<c:forEach
										items="${tDMClaimSearchDTO.tdmClaimTypeOfBillsMastDTOs}"
										var="tdmClaimTypeOfBillsMastDTOs">
										<form:option
											value="${tdmClaimTypeOfBillsMastDTOs.claimTypeOfBillDesc}">${tdmClaimTypeOfBillsMastDTOs.claimTypeOfBillDesc}</form:option>
									</c:forEach>
								</form:select></td>
						</tr>
						<tr>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.admissiondt" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="admissiondt" id="admissiondt"
									class="datepicker date-control" /></td>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.dischargedt" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="dischargedt" id="dischargedt"
									class="datepicker date-control" /></td>
						</tr>
					</tbody>
					...
					<tbody id="myContent">
						<tr>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.COB" /></td>
							<td class="flied-title" class="flied-title" align="left"
								valign="middle"><label class="checkbox-inline"> <form:checkbox
										path="claimWithCOB" id="claimWithCOB" value="C" />
							</label></td>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.auth" /></td>
							<td class="flied-title" class="flied-title" align="left"
								valign="middle"><label class="checkbox-inline"> <form:checkbox
										path="claimAuthOn" id="claimAuthOn" value="C" />
							</label></td>
						</tr>
						<tr>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.REF" /></td>
							<td class="flied-title" class="flied-title" align="left"
								valign="middle"><label class="checkbox-inline"> <form:checkbox
										path="claimRefOn" id="claimRefOn" value="C" />
							</label></td>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.interest" /></td>
							<td class="flied-title" class="flied-title" align="left"
								valign="middle"><label class="checkbox-inline"> <form:checkbox
										path="claimIntOn" id="claimIntOn" value="C" />
							</label></td>
						</tr>
						<tr>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.subc.subcId" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<form:input path="subscriberId" id="subscriberId"
									class="form-control" maxlength="51" />
							</td>
							<td class="lable-title" align="left" valign="middle"><spring:message
									code="label.claim.rcptdt" /></td>
							<td class="flied-title" align="left" valign="middle"><form:input
									path="rcptdt" id="rcptdt" class="datepicker date-control" /></td>
						</tr>
						<tr>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.claimId" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<form:input path="claimId" id="claimId" class="form-control"
									maxlength="21" />
							</td>
							<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
									code="label.claim.statusCode" /></td>
							<td class="flied-title" align="left" valign="middle" scope="col">
								<form:input path="statusCode" id="statusCode"
					...
					<tbody id="headerDiv">
						<tr>
							...
							<td align="left" valign="middle"></td>
							<td align="left" valign="middle"></td>
							<td class="lable-title" align="right" valign="middle"><a
								id="myHeader" href="javascript:toggle2('myContent','myHeader');"><spring:message
										code="label.showLink" /></a></td>
						</tr>
					</tbody>
					...
					<tr>
						...
						<td class="flied-title" align="left" valign="middle"><form:select
								path="searchRecordsNo" id="searchRecordsNo"
								class="down-control-small">
					...
					<tbody>
						<tr>
							<td colspan="4" align="center" valign="middle"><input
								...
								class="btn-primary btn-cell" value="Search"> <input
								type="reset" value="Reset" class="btn-primary btn-cell"
								onClick="clearFields('./testdaClaimUser');"></td>
						</tr>
					</tbody>
				</table>
				<br>
				<c:if
					test="${tDMClaimSearchDTO.tDMClaimSearchResultListDTOs eq null}">
					<c:if test="${result ne null}">
						...
						<c:if
							test="${tDMClaimSearchDTO.autoEmailDTOs ne null && empty tDMClaimSearchDTO.autoEmailDTOs && reserveFlag eq null}">
						...
						<c:if
							test="${tDMClaimSearchDTO.autoEmailDTOs ne null &&  not empty tDMClaimSearchDTO.autoEmailDTOs && reserveFlag eq null}">
							...
							<table class="table "
								...
								<tbody>
									<c:forEach items="${tDMClaimSearchDTO.autoEmailDTOs}"
										...
										<tr>
											...
											<td><input type="button" value="Email" id="jqxButton"
												class="btn-primaryemail btn-cellemail"
							...
							<ul class="grdPagination">
								<%
											...
											if (currentPage != 1) {
			   							%>
								<li><a href="testdaClaimUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li><a href="testdaClaimUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
								<li class="disable"><a href="testdaClaimUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li class="disable"><a
									href="testdaClaimUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
								...
								<%
			    						...
			    						%>
								<li><a href="testdaClaimUser?page=<%= i %>"
									id="employeeLink"><%= i %></a>
								<div><%= i %></div></li>
								<%
			    									}
								...
								<li><a href="testdaClaimUser?page=<%= currentPage+1 %>">&gt;</a>
								<div>&gt;</div></li>
								<li><a href="testdaClaimUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											} else {
											    if(noOfPages > 1) {
								...
								<div>&gt;</div></li>
								<li class="disable"><a
									href="testdaClaimUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											    }
											}
						...
						<c:if
							test="${tDMClaimSearchDTO.autoEmailDTOs eq null && empty tDMClaimSearchDTO.autoEmailDTOs}">
							...
							<table
								...
								<tbody>
									...
									<tr>
										<td class="lable-title" align="left" valign="middle"><spring:message
												code="label.email.l1l2" /> <input type="button"
											value="Email" id="jqxButton"
											class="btn-primaryemail btn-cellemail"
											onclick="popup('./popupEmail?result=${result}','L1/L2 Support','popup','popupOverlay','550');" />
										</td>
									</tr>
								</tbody>
							</table>
				...
				<c:if
					test="${tDMClaimSearchDTO.tDMClaimSearchResultListDTOs ne null &&  not empty tDMClaimSearchDTO.tDMClaimSearchResultListDTOs}">
					<%
						int currentPage = (Integer) request.getAttribute("currentPage");
						int count1 = currentPage - 1;
						count1 = count1 * 10;
					...
					<div>
						<table
							style="width: 100%; border: 0; font-size: 12px;; cellpadding: 4; align: center;">
							<tbody>
								<tr>
									<td class="lable-title" align="left" valign="middle"><spring:message
											code="label.tcId" /></td>
					...
					<div class="scrollingX" id="myid">
						<table id="search_output_table" class="table tablesorter"
							...
							<thead>
								<tr>
									...
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.type" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.patientFirstName" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.patientLastName" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.patientId" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.status" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.dx.code" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.proc.code" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.modifier" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.revenueCode" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.source" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.pos" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.typOfService" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.claimProviderTIN" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.provider.NPI" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.rcptdt" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.gender" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.statusCode" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.groupnum" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.totalCharge" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.totalAllowed" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.totalPaid" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.deductible" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.copay" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.coins" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.admissiondt" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.dischargedt" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.claim.typeOfBill" /></th>
								</tr>
							</thead>
							<tbody>
								<c:forEach items="${tDMClaimSearchResultListDTOs}"
									var="tDMClaimSearchResultListDTOs" varStatus="status">
									<tr>
										<c:if
											test="${tDMClaimSearchResultListDTOs.reservedYN eq null }">
											<td><form:checkbox
													path="tDMClaimSearchResultListDTOs[${status.index}].reservedYN"
													id="tDMClaimSearchResultListDTOs[${status.index}].reservedYN"
													class="cb_class checkBoxCls" value="Yes" /></td>
										</c:if>
                        ...
                        <form:hidden path="tDMClaimSearchResultListDTOs[${status.index}].reservedYN" />
							...
							<c:forEach
								items="${tDMClaimSearchDTO.tDMClaimSearchResultListDTOs}"
								var="tDMClaimSearchResultListDTOs" varStatus="status">
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimId" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimType" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].patientFirstName" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].patientLastName" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].patientId" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimStatus" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimDXCode" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimProcCode" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimModifier" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimRevCode" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimSource" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimPOS" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimServiceType" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimProviderTIN" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimReceiptDate" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimPatientGender" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].claimGrpNum" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].totalCharge" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].totalAllowed" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].totalPaid" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].deductible" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].copay" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].coins" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].admissionDate" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].dischargeDate" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].typeofBill" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].testCaseId" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].testCaseName" />
								<form:hidden
									path="tDMClaimSearchResultListDTOs[${status.index}].userId" />
							</c:forEach>
						</table>
					</div>
					...
					<ul class="grdPagination">
						...
						<%
			    						...
			    						%>
						<li><a href="testdaClaimUser?page=<%= i %>" id="employeeLink"><%= i %></a>
						<div><%= i %></div></li>
						<%
			    									}
			    								}
						...
						<tbody>
							<tr>
								<th scope="col"><input type="submit" name="reserve"
									id="reserve" class="btn-primary btn-cell" value="Reserve">
