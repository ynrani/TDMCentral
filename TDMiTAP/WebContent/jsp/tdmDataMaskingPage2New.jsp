	    ...
	    <li><a class="hrefVisited" href="./tdmDtMaskDashboard">Data Masking Dashboard</a></li> -->
			...
			<div class="two-col">
				<form:form id="dataMaskingForm2" name="dataMaskingForm2"
					action="${pageContext.request.contextPath}/tdmDataMaskingPage2New"
								...
								<tbody>
									<tr>
										<th scope="col"><input type="submit" name="submit"
											id="back" class="btn-primary btn-cell" value="Back">
											<input type="submit" name="submit" id="savncont"
						...
						<c:when test="${changeReqYN eq true}">
							<table style="width: 100%; border: 0">
								<tbody>
									<tr>
										<th scope="col"><input type="submit" name="submit"
											id="SaveAndContinue" class="btn-primary btn-cell"
											value="Save and Continue"></th>
									</tr>
								</tbody>
							</table>
						</c:when>
						<c:otherwise>
							<table style="width: 100%; border: 0; align: center;">
								<tbody>
									<tr>
										<th scope="col"><input type="submit" name="submit"
											id="back2" class="btn-primary btn-cell" value="Back">
											<input type="submit" name="submit" id="contin"
