	...
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-1" class="container">
			...
			<form:form id="testDataForm" name="testDataForm"
				action="${pageContext.request.contextPath}/testdaUser"
				modelAttribute="tDMProvSearchDTO">
				<div class="">
					...
					<table
						...
						<tbody>
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:select path="provCatgType" id="provCatgType"
										...
										<form:option value="">All</form:option>
										<c:forEach
											items="${tDMProvSearchDTO.tdmProviderCatParentDTOs}"
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMProvSearchDTO.specDropdown}"
											var="specDropdown">
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMProvSearchDTO.tdmUsStateDTOs}"
											var="tdmUsStateDTOs">
							...
							<tr>
								<td class="flied-title" align="left"><spring:message
										code="label.prov.atypical" /></td>
								<td class="flied-title"><label class="checkbox-inline">
										<form:checkbox path="provTypicalYn" id="provTypicalYn"
											value="Yes" />
								</label></td>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.eft" /></td>
								<td class="flied-title"><label class="checkbox-inline">
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.coverage" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="coverage" id="coverage" class="down-control">
										<form:option value="">All</form:option>
						...
						<tbody id="myContent">
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="taxonomyCode" id="taxonomyCode"
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="effectiveDate" id="effectiveDate"
										class="date-control datepicker from" readonly="ture" />
								</td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
								...
								<td class="flied-title" align="left" valign="middle"><form:input
										path="termDate" id="termDate"
										class="date-control datepicker to" readonly="ture" /></td>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.tin" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="tin" id="tin" class="form-control" maxlength="10" /></td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.npi" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="nip" id="nip" class="form-control" maxlength="11" /></td>

								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.mdId" /></td>
								<td class="flied-title" class="flied-title" align="left"
									valign="middle"><form:input path="medicareId"
										id="medicareId" class="form-control" maxlength="51" /></td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.prov.contractCode" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
								...
								<td class="flied-title" class="flied-title" align="left"
									valign="middle"><label class="radio-inline"> <form:radiobutton
											path="gender" id="gender" value="Male" />
									...
									class="radio-inline"> <form:radiobutton path="gender"
										...
										<spring:message code="label.female" />
											...
											path="gender" id="gender" value="Both" />
						...
						<tbody>
							<tr>
								<td colspan="4" align="center" valign="middle"><input
									...
									onClick="clearFields('./testdaUser');"></td>
							</tr>
						</tbody>
					</table>
				...
				<c:if test="${tDMProvSearchDTO.tDMProvSearchResultListDTOs eq null}">
					...
					<c:if test="${result ne null}">
						...
						<c:if
							test="${tDMProvSearchDTO.autoEmailDTOs ne null && empty tDMProvSearchDTO.autoEmailDTOs && reserveFlag eq null}">
						...
						<c:if
							test="${tDMProvSearchDTO.autoEmailDTOs ne null &&  not empty tDMProvSearchDTO.autoEmailDTOs && reserveFlag eq null}">
							...
							<table class="table "
								...
								<tbody>
									<c:forEach items="${tDMProvSearchDTO.autoEmailDTOs}"
							...
							<ul class="grdPagination">
								<%
											...
											if (currentPage != 1) {
			   							%>
								<li><a href="testdaUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li><a href="testdaUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
								<li class="disable"><a href="testdaUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li class="disable"><a
									href="testdaUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
								...
								<%
			    						...
			    						%>
								<li><a href="testdaUser?page=<%= i %>" id="employeeLink"><%= i %></a>
								<div><%= i %></div></li>
								<%
			    									}
			    								}
								...
								<li><a href="testdaUser?page=<%= currentPage+1 %>">&gt;</a>
								<div>&gt;</div></li>
								<li><a href="testdaUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											} else {
											    if(noOfPages > 1) {
								...
								<div>&gt;</div></li>
								<li class="disable"><a
									href="testdaUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											    }
											}
						...
						<c:if
							test="${tDMProvSearchDTO.autoEmailDTOs eq null && empty tDMProvSearchDTO.autoEmailDTOs}">
								...
								<tbody>
									...
									<tr>
										<td class="lable-title" align="left" valign="middle"><spring:message
											...
											value="Email" class="btn-primaryemail btn-cellemail"
				...
				<c:if
					test="${tDMProvSearchDTO.tDMProvSearchResultListDTOs ne null &&  not empty tDMProvSearchDTO.tDMProvSearchResultListDTOs}">
					<%
									int currentPage = (Integer) request.getAttribute("currentPage");
									int count1 = currentPage - 1;
									count1 = count1 * 10;
						...
						<table id="search_output_table" class="table tablesorter"
							...
							<thead>
								<tr>
									...
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.licenseNo" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.tin" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.npi" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.medicareId" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.contract" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.eft" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.gender" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.termdt" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.addLine1" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.addLine2" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.prov.city" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
							...
							<tbody>
								<c:forEach
									...
									<tr>
										<c:if
											test="${tDMProvSearchResultListDTOs.reservedYN eq null }">
											<td><label class="checkbox-inline"> <form:checkbox
														path="tDMProvSearchResultListDTOs[${status.index}].reservedYN"
														id="tDMProvSearchResultListDTOs[${status.index}].reservedYN"
								...
								<c:forEach
									...
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].firstName" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].lastName" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].atypical" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provType" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provCatgType" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].specialityDescription" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].licenseNo" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].tin" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].npi" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].medicareId" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provContactType" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provFET" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provGender" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].terminationDate" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provAddr1" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provAddr2" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provCity" />
									<form:hidden
										path="tDMProvSearchResultListDTOs[${status.index}].provState" />
									<form:hidden
