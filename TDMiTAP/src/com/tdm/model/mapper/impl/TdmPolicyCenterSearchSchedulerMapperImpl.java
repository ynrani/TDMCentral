 ...
 */
@Component
@Service("tdmPolicyCenterSearchSchedulerMapperImpl")
public class TdmPolicyCenterSearchSchedulerMapperImpl{

	
	public TdmPolicyCenterSearchDTO converObjectToTdmPolicyCenterSearchDTO(
			List<Object[]> lstObjects, List<TdmReservationDO> reservationDOs, String userId,Map<Long,String> countriesValues, Map<Long, String> mapInsurers)
		...
		if(null != lstObjects && !lstObjects.isEmpty()){
			for(Object[] objs: lstObjects){
				...
				if(objs[i] !=null && StringUtils.isNotEmpty(String.valueOf(objs[i])))
					tdmPolicyCenterSearchResultDTO.setInsurerType(mapInsurers.get(Long.parseLong(String.valueOf(objs[i]))));
				i++;
	...
	public List<PctlStateDTO> convertgetStateCodesDOTOgetStateCodesDTOS(List<PctlStateDO> listResult){
	...
	public List<PctlCountryDTO> convertCountryDOTOCountryDTOS(List<PctlCountryDO> listResult){
