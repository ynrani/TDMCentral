...
/**
 * The persistent class for the PCTL_COUNTRY database table.
 * 
 */
@Entity
@Table(name="PCTL_COUNTRY")
@NamedQuery(name="PctlCountryDO.findAll", query="SELECT p FROM PctlCountryDO p")
public class PctlCountryDO implements Serializable {
