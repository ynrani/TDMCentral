...
public class PcPolicyperiodDO implements Serializable {
	...
	//bi-directional many-to-one association to PcBillinginvoicestreamDO
	@OneToMany(mappedBy="pcPolicyperiod")
	private List<PcBillinginvoicestreamDO> pcBillinginvoicestreams;

	//bi-directional many-to-one association to PcContactDO
	@ManyToOne
	@JoinColumn(name="PNICONTACTDENORM" , insertable=false, updatable=false)
	...
	@ManyToOne
	@JoinColumn(name="POLICYTERMID")
	private PcPolicytermDO pcPolicyterm;
	...
	public List<PcBillinginvoicestreamDO> getPcBillinginvoicestreams() {
		return this.pcBillinginvoicestreams;
	}

	public void setPcBillinginvoicestreams(List<PcBillinginvoicestreamDO> pcBillinginvoicestreams) {
		this.pcBillinginvoicestreams = pcBillinginvoicestreams;
	}

	public PcBillinginvoicestreamDO addPcBillinginvoicestream(PcBillinginvoicestreamDO pcBillinginvoicestream) {
		getPcBillinginvoicestreams().add(pcBillinginvoicestream);
		pcBillinginvoicestream.setPcPolicyperiod(this);

		return pcBillinginvoicestream;
	}

	public PcBillinginvoicestreamDO removePcBillinginvoicestream(PcBillinginvoicestreamDO pcBillinginvoicestream) {
		getPcBillinginvoicestreams().remove(pcBillinginvoicestream);
		pcBillinginvoicestream.setPcPolicyperiod(null);
	...
	public PcPolicytermDO getPcPolicyterm() {
		return this.pcPolicyterm;
	}

	public void setPcPolicyterm(PcPolicytermDO pcPolicyterm) {
		this.pcPolicyterm = pcPolicyterm;
	}
