...
<body>
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-1" class="container">
			...
			<form:form id="testDataFormSubsc" name="testDataFormSubsc"
				class="testval"
				action="${pageContext.request.contextPath}/testdaSubscUser"
				modelAttribute="tDMSubscSearchDTO">
				<div class="">
					<table
						...
						<tbody>
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<label class="radio-inline"> <form:radiobutton
											path="subscGender" id="subscGender" value="Male" />
										<spring:message code="label.male" /></label> <label
									class="radio-inline"> <form:radiobutton
											path="subscGender" id="subscGender" value="FeMale" />
										<spring:message code="label.female" />
								</label> <label class="radio-inline"> <form:radiobutton
											path="subscGender" id="gender" value="Both" />
										<spring:message code="label.both" />
								</label>
								</td>
								<td class="lable-title" align="left" valign="middle" scope="col"><spring:message
										code="label.subc.type" /></td>
								<td class="flied-title" align="left" valign="middle" scope="col">

									<form:select path="subscType" id="subscType"
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMSubscSearchDTO.tdmSubscTypeMastDTOs}"
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										path="subscStatus" id="subscStatus" multiple="true"
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMSubscSearchDTO.tdmSubscStatusMastDTOs}"
								...
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.state" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="subscState" id="subscState" multiple="true"
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMSubscSearchDTO.tdmUsStateDTOs}"
											var="tdmUsStateDTOs">
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.lob" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="subscLOB" id="subscLOB" multiple="true"
										class="down-control">
										<form:option value="">All</form:option>
										<c:forEach items="${tDMSubscSearchDTO.tdmSubscLobMastDTOs}"
											var="tdmSubscLobMastDTOs">
								...
								<td>
									<table style="padding-bottom: 15px; cellpadding: 10;">
										<tr>
											<td class="lable-title" align="left" valign="middle"><spring:message
													code="label.subc.age" /></td>
										</tr>
										<tr>
											<td class="lable-title" align="left" valign="middle"
												scope="col"><spring:message code="label.subc.cob" /></td>
										</tr>
									</table>
								</td>
								<td>
									<table style="padding-bottom: 15px; cellpadding: 10;">
										<tr>
											<td class="flied-title" align="left" valign="middle"><spring:message
													code="label.subc.between" /> <form:input
													path="subscAgeStart" id="subscAgeStart" size="5"
													maxlength="2" class="form-control-half" />
												<spring:message code="label.subc.and" /> <form:input
													path="subscAgeEnd" id="subscAgeEnd" size="5" maxlength="2"
													class="form-control-half greaterThan" /></td>
										</tr>
										<tr>
											<td class="flied-title" class="flied-title" align="left"
												valign="middle"><label class="checkbox-inline">
													<form:checkbox path="subscWithCOB" id="subscWithCOB"
														value="C" />
											</label></td>
										</tr>
									</table>
						...
						<tbody id="myContent">
							...
							<tr>
								...
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.planid" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="planID" id="planID" class="form-control" maxlength="21" />
								</td>
							</tr>
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.plnname" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="planName" id="planName" class="form-control"
										maxlength="21" /></td>

								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.trmDt" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="termDate" id="termDate" class="datepicker date-control" />
								</td>
							</tr>

							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.subc.contractCode" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="contractCode" id="contractCode" class="form-control"
										maxlength="21" /></td>
						...
						<tbody>
							<tr>
								<td colspan="4" align="center" valign="middle"><input
									...
									onClick="clearFields('./testdaSubscUser');"></td>
							</tr>
						</tbody>
					</table>
				...
				<c:if
					test="${tDMSubscSearchDTO.tDMSubscSearchResultListDTOs eq null}">
					<c:if test="${result ne null}">
						...
						<c:if
							test="${tDMSubscSearchDTO.autoEmailDTOs ne null && empty tDMSubscSearchDTO.autoEmailDTOs && reserveFlag eq null}">
							<table
						...
						<c:if
							test="${tDMSubscSearchDTO.autoEmailDTOs ne null &&  not empty tDMSubscSearchDTO.autoEmailDTOs && reserveFlag eq null}">
							...
							<table class="table "
								...
								<tbody>
									<c:forEach items="${tDMSubscSearchDTO.autoEmailDTOs}"
							...
							<ul class="grdPagination">
								<%
											...
											if (currentPage != 1) {
			   							%>
								<li><a href="testdaSubscUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li><a href="testdaSubscUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
								<li class="disable"><a href="testdaSubscUser?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li class="disable"><a
									href="testdaSubscUser?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
								...
								<%
			    						...
			    						%>
								<li><a href="testdaSubscUser?page=<%= i %>"
									id="employeeLink"><%= i %></a>
								<div><%= i %></div></li>
								<%
			    									}
								...
								<li><a href="testdaSubscUser?page=<%= currentPage+1 %>">&gt;</a>
								<div>&gt;</div></li>
								<li><a href="testdaSubscUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											} else {
											    if(noOfPages > 1) {
								...
								<div>&gt;</div></li>
								<li class="disable"><a
									href="testdaSubscUser?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											    }
											}
						...
						<c:if
							test="${tDMSubscSearchDTO.autoEmailDTOs eq null && empty tDMSubscSearchDTO.autoEmailDTOs}">
				...
				<c:if
					test="${tDMSubscSearchDTO.tDMSubscSearchResultListDTOs ne null &&  not empty tDMSubscSearchDTO.tDMSubscSearchResultListDTOs}">
					<%
									int currentPage = (Integer) request.getAttribute("currentPage");
									int count1 = currentPage - 1;
									count1 = count1 * 10;
						...
						<table id="search_output_table" class="table tablesorter"
							...
							<thead>
								<tr>
									...
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.dependId" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.ssn" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.fname" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.lname" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.gender" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.dob" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.status" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.grp" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.effDt" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.stype" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.addLine1" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.addLine2" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.city" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.state" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.zip" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.contractCode" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.lob" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.planid" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.plnname" /></th>
									<th bgcolor="#0328FF" scope="col" class="whitefont"><spring:message
											code="label.subc.pcp" /></th>
								</tr>
							</thead>

							<tbody>
								<c:forEach items="${tDMSubscSearchResultListDTOs}"
									var="tDMSubscSearchResultListDTOs" varStatus="status">
									<tr>

										<c:if
											test="${tDMSubscSearchResultListDTOs.reservedYN eq null }">
											<td><form:checkbox
													path="tDMSubscSearchResultListDTOs[${status.index}].reservedYN"
													id="tDMSubscSearchResultListDTOs[${status.index}].reservedYN"
							...
							<c:forEach
								items="${tDMSubscSearchDTO.tDMSubscSearchResultListDTOs}"
								var="tDMSubscSearchResultListDTOs" varStatus="status">

								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subscriberId" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].dependentId" />

								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].ssn" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].firstName" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].lastName" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].gender" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].birthDate" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcStatus" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subscriberNames" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].dateChanged" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcType" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcAddr1" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcAddr2" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcCity" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcState" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcZip" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].subcContCode" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].lob" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].planId" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].planName" />
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].pcp" />
								...
								<form:hidden
									path="tDMSubscSearchResultListDTOs[${status.index}].userId" />
					...
					<ul class="grdPagination">
						...
						<%
			    						...
			    						%>
						<li><a href="testdaSubscUser?page=<%= i %>" id="employeeLink"><%= i %></a>
						<div><%= i %></div></li>
						<%
			    									}
			    								}
