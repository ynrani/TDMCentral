...
<body>
	<div id="main" class="wrapper mainAll">
		...
		<div id="tabs-1" class="container">
			<form:form id="claimSearchForm" name="claimSearchForm"
				action="${pageContext.request.contextPath}/claimSearch"
				modelAttribute="tdmPolicyClaimSearchDTO">
				<div class="">
						...
						<tbody>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.claim.comp" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="company" id="company" class="down-control">
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.claim.prodName" /></td>
								<td class="flied-title" align="left" valign="middle"><form:select
										path="productName" id="productName" class="down-control">
										<form:option value="">All</form:option>
								...
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.claim.poilcyNum" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="policyNo" id="policyNo" class="form-control"
										maxlength="21" /></td>
							</tr>
							...
							<tr>
								...
								<td class="flied-title" class="flied-title" align="left"
									valign="middle"><form:select path="policySts"
										id="policySts" class="down-control">
										<form:option value="">All</form:option>
							...
							<tr>
								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.claim.agentId" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="agntId" id="agntId" class="form-control" maxlength="21" />
								</td>

								<td class="lable-title" align="left" valign="middle"><spring:message
										code="label.claim.dob" /></td>
								<td class="flied-title" align="left" valign="middle"><form:input
										path="dob" id="dob" class="date-control datepicker" /></td>
							</tr>
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:input path="fromDate" id="fromDate"
										class="date-control datepicker from" />
								</td>
								<td class="lable-title" align="left" valign="middle" scope="col">
						...
						<tbody>
							<tr>
								<td colspan="4" align="center" valign="middle"><input
									...
									onClick="clearFields('./claimSearch');" /></td>
							</tr>
						</tbody>
					</table>
				...
				<c:if
					test="${tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs eq null}">
					...
					<c:if test="${result ne null}">
						...
						<c:if
							test="${tdmPolicyClaimSearchDTO.autoEmailDTOs ne null && empty tdmPolicyClaimSearchDTO.autoEmailDTOs && reserveFlag eq null}">
						...
						<c:if
							test="${tdmPolicyClaimSearchDTO.autoEmailDTOs ne null &&  not empty tdmPolicyClaimSearchDTO.autoEmailDTOs && reserveFlag eq null}">
							...
							<table class="table "
								...
								<tbody>
									<c:forEach items="${tdmPolicyClaimSearchDTO.autoEmailDTOs}"
							...
							<ul class="grdPagination">
								<%
											...
											if (currentPage != 1) {
			   							%>
								<li><a href="claimSearch?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li><a href="claimSearch?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
								<li class="disable"><a href="claimSearch?page=<%= 1 %>">&lt;&lt;</a>
								<div>&lt;&lt;</div></li>
								<li class="disable"><a
									href="claimSearch?page=<%= currentPage-1 %>">&lt;</a>
								<div>&lt;</div> <%
			   								 	}
			   								}
											if(noOfPages > 1) {
								...
								<%
			    						...
			    						%>
								<li><a href="claimSearch?page=<%= i %>" id="employeeLink"><%= i %></a>
								<div><%= i %></div></li>
								<%
			    									}
			    								}
								...
								<li><a href="claimSearch?page=<%= currentPage+1 %>">&gt;</a>
								<div>&gt;</div></li>
								<li><a href="claimSearch?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											} else {
											    if(noOfPages > 1) {
								...
								<div>&gt;</div></li>
								<li class="disable"><a
									href="claimSearch?page=<%= noOfPages %>">&gt;&gt;</a>
								<div>&gt;&gt;</div></li>
								<%
											    }
											}
						...
						<c:if
							test="${tdmPolicyClaimSearchDTO.autoEmailDTOs eq null && empty tdmPolicyClaimSearchDTO.autoEmailDTOs}">
				...
				<c:if
					test="${tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs ne null &&  not empty tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs}">
					<%
									int currentPage = (Integer) request.getAttribute("currentPage");
									int count1 = currentPage - 1;
									count1 = count1 * 10;
					...
					<div class="scrollingX" id="myid">
						<table id="search_output_table" class="table tablesorter"
							...
							<thead>
								<tr>
									...
									<th bgcolor="#E3EFFB" height="25" class="whitefont"><spring:message
											code="label.claim.claimNo" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.policyNo" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.comp" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.prodName" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.poilcySts" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.faceAmt" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.insuFname" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.policy.insuLname" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.ssn" /></th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont"><spring:message
											code="label.claim.dob" /></th>
									...
									<th bgcolor="#E3EFFB" scope="col" class="whitefont">Payment
										Mode</th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont">Payment
										Method</th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont">Cash
										Accumulated</th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont">Loan
										Amount</th>
									<th bgcolor="#E3EFFB" scope="col" class="whitefont">Loan
										Repay Amount</th>
							...
							<tbody>
								<c:forEach
									items="${tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs}"
									var="tdmClaimSearchResultDTOs" varStatus="status">
									<tr>
										<c:if test="${tdmClaimSearchResultDTOs.reservedYN eq null }">
											<td><label class="checkbox-inline"> <form:checkbox
														path="tdmClaimSearchResultDTOs[${status.index}].reservedYN"
														id="tdmClaimSearchResultDTOs[${status.index}].reservedYN"
								...
								<c:forEach
									...
									var="tdmClaimSearchResultDTOs" varStatus="status">
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].claimNo" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].policyNo" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].productName" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].companyName" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].faceAmt" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].productType" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].fristName" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].lastName" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].ssn" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].dob" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].riders" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].benefits" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].owner" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].beneficiary" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].paymentMethod" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].paymentMode" />

									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].policySts" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].cashAccum" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].loanAmt" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].loanRepayAmt" />

									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].testCaseId" />
									<form:hidden
										path="tdmClaimSearchResultDTOs[${status.index}].testCaseName" />
								</c:forEach>
							</tbody>
						</table>
					</div>
