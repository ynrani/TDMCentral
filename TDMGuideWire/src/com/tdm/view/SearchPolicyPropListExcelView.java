...
public class SearchPolicyPropListExcelView extends AbstractExcelView
{
	...
	public void setExcelHeader(HSSFSheet excelSheet, HSSFCellStyle style) {
		...
		excelHeader.createCell(1).setCellValue("Account Number");
		excelHeader.createCell(2).setCellValue("Policy Type");
		excelHeader.createCell(3).setCellValue("First Name");
		excelHeader.createCell(4).setCellValue("Last Name");
		excelHeader.createCell(5).setCellValue("Insurer Type");
		excelHeader.createCell(6).setCellValue("Email Address1");
		excelHeader.createCell(7).setCellValue("Email Address2");
		excelHeader.createCell(8).setCellValue("Address Line1");
		excelHeader.createCell(9).setCellValue("Address Line2");
		excelHeader.createCell(10).setCellValue("Address Line3");
		
		excelHeader.createCell(11).setCellValue("Original Effective Date");
		excelHeader.createCell(12).setCellValue("Expiration Date");
		excelHeader.createCell(13).setCellValue("Phone Number");
		excelHeader.createCell(14).setCellValue("Country");
	...
	public void setExcelRows(HSSFSheet excelSheet,
		...
		for (TdmPolicyCenterSearchResultDTO tdmPolicyPropertySearchResultDTO : searchPolicyPropOutputList) {
			...
			excelRow.createCell(1).setCellValue(tdmPolicyPropertySearchResultDTO.getAccoutnumber());
			excelRow.createCell(2).setCellValue(tdmPolicyPropertySearchResultDTO.getProductType());
			excelRow.createCell(3).setCellValue(tdmPolicyPropertySearchResultDTO.getFirstName());
			excelRow.createCell(4).setCellValue(tdmPolicyPropertySearchResultDTO.getLastName());
			excelRow.createCell(5).setCellValue(tdmPolicyPropertySearchResultDTO.getInsurerType());
			excelRow.createCell(6).setCellValue(tdmPolicyPropertySearchResultDTO.getEmailAddress());
			excelRow.createCell(7).setCellValue(tdmPolicyPropertySearchResultDTO.getEmailAddress2());
			...
			excelRow.createCell(11).setCellValue(tdmPolicyPropertySearchResultDTO.getOriginalEffectiveDate());

			
			excelRow.createCell(12).setCellValue(tdmPolicyPropertySearchResultDTO.getExpirationDate());
			excelRow.createCell(13).setCellValue(tdmPolicyPropertySearchResultDTO.getWorkPhoneNo());
			excelRow.createCell(14).setCellValue(tdmPolicyPropertySearchResultDTO.getCountry());
