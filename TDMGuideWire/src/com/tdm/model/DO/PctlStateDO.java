...
/**
 * The persistent class for the PCTL_STATE database table.
 * 
 */
@Entity
@Table(name="PCTL_STATE")
@NamedQuery(name="PctlStateDO.findAll", query="SELECT p FROM PctlStateDO p")
public class PctlStateDO implements Serializable {
