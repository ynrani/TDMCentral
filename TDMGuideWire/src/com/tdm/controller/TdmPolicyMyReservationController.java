...
public class TdmPolicyMyReservationController
{
	...
	TdmPolicyCenterSearchService tdmPolicySearchService;

	//List<TdmPolicySearchResultDTO> tdmPolicySearchResultDTOs = null;
	TdmPolicyCenterSearchDTO tdmPolicyCenterSearchDTO = null;
	...
	public String myReservationRecordPolicy(
		...
		try {
			...
			TdmPolicyCenterSearchDTO tdmPolicySearchDTO = tdmPolicySearchService
					.getReservedRecordForUser(UserId, offSet, recordsperpage, true);
			//String searchType = AppConstant.POLICY;
			totalRecords = tdmPolicySearchService.getReservedRecordsCount(null, UserId);
			...
			model.addAttribute(MessageConstant.TDM_POLICY_RESULT_EXPO_DTOS,
					tdmPolicySearchDTO.getListTdmPolicyCenterSearchResultDTO());
			tdmPolicyCenterSearchDTO = tdmPolicySearchDTO;
	...
	public ModelAndView findTestPolicyReservedDataExport(ModelMap model,
		...
		return new ModelAndView(MessageConstant.TDM_POLICY_EXPO_XLS,
				"tdmPolicyCenterSearchDTO", tdmPolicyCenterSearchDTO.getListTdmPolicyCenterSearchResultDTO());
	}
