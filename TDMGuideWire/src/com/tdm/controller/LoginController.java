...
public class LoginController
{
	...
	@Autowired
	private TdmPolicyCenterSearchService tdmPolicyCenterSearchServiceImpl;
...
/*Runnable runnable = new Runnable(){
			...
			public void run(){
				...
				try {
					tdmPolicyCenterSearchDTOtemp = tdmPolicyCenterSearchServiceImpl.searchPolicyCenter(input,
							0, 10, true, "demo");
