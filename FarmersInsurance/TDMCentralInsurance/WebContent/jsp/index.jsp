				...
				<div class="gridCntr">
					...
					<diV class="thumbnail gutter design">
						...
						<ul>
							...
							<li><a href=" http://in-pnq-coe13.corp.capgemini.com/SensitivityProfiler/" TARGET="_NEW">Sensitivity
									Profiler</a></li>
						</ul>
					</diV>
					<!-- /Thumbnail for Design -->
					...
					<diV class="thumbnail gutter prepare">
						...
						<p>Prepare required test data as per design and test data need
							from testing team</p>
						<ul>
							<li><a href="http://in-pnq-coe13.corp.capgemini.com/SensitivityProfiler/">DATA MASKING</a></li>
						</ul>
					</diV>
					<!-- /Thumbnail for Prepare -->
					...
					<diV class="thumbnail gutter provision">
						...
						<ul>
							<li><a href="./policyProp">Find Test Data and
									Reservation</a></li>
							<li><a href="http://in-pnq-coe12:8080/TDGV3/">TDG</a></li>
