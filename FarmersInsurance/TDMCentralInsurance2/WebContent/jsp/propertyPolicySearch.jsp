						...
						<tbody>
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										<form:option value="HO4">NGHO</form:option>
										<form:option value="HO6">FSPH</form:option>
										<form:option value="DP3">SPF</form:option>
										<form:option value="HO3">LP</form:option>
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle" scope="col">
									<form:select path="policyStage" id="policyStage"
										...
										<form:option value="active">In-Active</form:option>
