...
<jsp:include page="indexHeader.jsp"></jsp:include>
  <div class="container">
    <form:form id="dataChMgmtForm" name="dataChMgmtForm" action="${pageContext.request.contextPath}/tdmDataChMgmt" modelAttribute="tdgChangeMgmtDTO">
	    ...
	    <li>&#x2f;</li>
	    <li class="active"><spring:message code="label.changemanagement"/></li>
	  </ol>
        ...
        <br/>
         <table style="width:100%; border:0; ">
            <tbody>
              <tr>
                  <th scope="col">
                    <input type="button" name="submit" class="btn-primary btn-cell" value="<spring:message code="label.submit"/>"> 
                 </th>
               </tr>
            </tbody>
         </table>
