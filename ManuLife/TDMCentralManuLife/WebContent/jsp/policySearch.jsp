              ...
              <tbody>
               ...
               <tr>
                 ...
                 <td class="flied-title" class="flied-title" align="left" valign="middle">
                    ...
                    <label class="radio-inline">
                      <form:radiobutton path="gender" id="gender" value="Both" /> <spring:message code="label.any" />
                    </label>
                  </td>
                ...
                <tr>
                  <td colspan="4" align="center" valign="middle">
                   <input type="submit" name="search" id="Search" class="btn-primary btn-cell" value="<spring:message code="button.serch"/>">
                    <input type="reset" value="<spring:message code="label.reset"/>" class="btn-primary btn-cell" onClick="clearFields('./policySearch');"/>
                  </td>
                </tr>
              </tbody>
            </table>
	...
	$(document).ready(function() {
	    $("#export").click(function(){
     	 ...
     	 var checkboxes = $('.checkBoxCls');
	    	  ...
	    	  if (selected == false) {
	    		  $('#search_output_table').after('<div class="my-error-class">${notselect}</div>');
	    		  return false;
	      	    }
	  	  });  
