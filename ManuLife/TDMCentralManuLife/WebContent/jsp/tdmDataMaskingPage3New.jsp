...
<body>
 ...
 <div class="container">
	  ...
	  <ol class="breadcrumb">
	    ...
	    <li>&#x2f;</li>
	    <li><a class="hrefVisited" href="./index"><spring:message code="label.tdmlifecycle"/></a></li>
	    <!-- <li>&#x2f;</li>
		<li><a class="hrefVisited" href="./tdmDtMaskDashboard">Data Masking Dashboard</a></li> -->
	    <li>&#x2f;</li>
	    <li class="active"><spring:message code="label.datamasking"/></li>
	  </ol>  
	  <div class="three-step-container">
	      <div class="step1"><span class="step-number1">1</span><span class="step-heading"><spring:message code="label.dm.reqDtl"/></span></div>
	      <div class="step2"><span class="step-number2">2</span><span class="step-heading"><spring:message code="label.dm.preReqs"/></span></div>
	      <div class="step3-active"><span class="step-number3">3</span><span class="step-heading"><spring:message code="label.dm.dtl"/></span></div>
	   </div>
			...
			<table style="width:100%; border:0; font-size: 14px; font-style: italic; color:#A56C33; cellpadding:4;">
              <tbody>
                <tr>
                  ...
                  <td style="color: red"><a href="${pageContext.request.servletContext.contextPath}/tdmDtMaskDashboard"><spring:message code="label.backtodashboard"/></a></td>
                </tr>
              </tbody>
            </table>
       </c:if>     
    ...
    <div>
		...
		<c:choose>
     	 <c:when test="${(readOnly eq null) && (disabled eq null)}">
           <th class="lable-title" width="10%" style="font-size:14px; "><spring:message code="label.action"/></th>
         </c:when> 
        </c:choose> 
		 
			<th class="lable-title" width="30%" style="font-size:14px; "><spring:message code="label.dt.applicationame"/><span>*</span></th>
			<th class="lable-title" width="30%" style="font-size:14px; "><spring:message code="label.dt.database"/><span>*</span></th>
			<th class="lable-title" width="30%" style="font-size:14px; "><spring:message code="label.dt.nooftables"/><span>*</span></th>
		</tr>
     	 			...
     	 			<td class="noWrapTxt algnRght" >
           			<c:choose>
						<c:when test="${frRow==listSize}">
							<a href="javascript:;" class="sprite icon-add  addRow_DMASK" id="tdgDataMaskingNoOfAppsDTOs"><spring:message code="label.add"></spring:message></a>
						</c:when>
						<c:otherwise>
							<a href="javascript:;" class="delRowFromDB_DMASK sprite icon-delete" id="tdgDataMaskingNoOfAppsDTOs"><spring:message code="label.delete"/></a>
						</c:otherwise>
  					</c:choose>
  					</td>
         		</c:when> 
    ...
    <c:if test="${changeReqYN eq true}">
        <table style="width:100%; border:0; font-size: 13px; color: #0C5473;; cellpadding:4;">
          <tbody>
           <tr>
              <td class="lable-title" width="35%" align="left" valign="middle"><spring:message code="label.changerequestdes"> </spring:message><span>*</span> </td>
              <td class="flied-title" width="20%" align="left" valign="middle">
      ...
      <c:when test="${(readOnly eq null) && (disabled eq null)}">
         <table  style="width:100%; border:0;font-size: 13px; color: #0C5473;align:center; ">
            <tbody>
               <tr>
                 <th scope="col">
                    <input type="button"  id="back" name="back" class="btn-primary btn-cell" value="<spring:message code="label.back"/>"> 
                    <input type="submit" id="submit" name="submit" class="btn-primary btn-cell" value="<spring:message code="label.submit"/>"> 
                    <input type="button"  id="cancel" name="cancel" class="btn-primary btn-cell" value="<spring:message code="label.cancel"/>">                     
                 </th>
               </tr>
            </tbody>
         </table>
         ...
         <c:otherwise>
           <table style="width:100%; border:0; align:center;">
            <tbody>
              <tr>
                  <th scope="col">
                    <input type="button"  id="readBack" name="readBack" class="btn-primary btn-cell" value="<spring:message code="label.back"/>"> 
                    <input type="button" name="export" id="export" class="btn-primary btn-cell" value="<spring:message code="button.export"/>"> 
                 </th>
               </tr>
            </tbody>
         </table>
