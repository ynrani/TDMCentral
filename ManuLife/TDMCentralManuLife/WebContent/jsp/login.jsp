    ...
    <div class="login-container">
      ...
      <h2>Login</h2>      
	   ...
	   <form:form id="loginForm" name="loginForm" action="${pageContext.request.contextPath}/tesdaLogin" method="post">
					...
					<input type="text" value="" placeholder="<spring:message code="label.userId"/>" name="userid" class="inputText">
			
					<input type="password" value="" placeholder="<spring:message code="label.password"/>" name="password" class="inputText">
				
					<input type="text"  id="projectId" name="projectId" placeholder="<spring:message code="label.projectid"/>" class="inputText">
				
					<input type="checkbox" value="" checked> <label><spring:message code="label.rememberme"/></label>
				
					<a href="javascript:;" class="forgot-password" onclick="popupuser('./loginforgotPassword','Forgot Password','popup','popupOverlay','300');"><label><spring:message code="label.forgotpass"/></label></a>
				
					<input type="submit" value="<spring:message code="label.login"/>" name="submit" id="submit" class="btn-primarylog btn-celllog">
