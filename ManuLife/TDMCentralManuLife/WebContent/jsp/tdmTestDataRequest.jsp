...
<body>
	<div class="wrapper mainAll">
	    ...
	    <li><a class="hrefVisited" href="./index"><spring:message code="label.tdmlifecycle"/></a></li>
					<li>&#x2f;</li>
					<li class="active"><spring:message code="label.tdm.tdr"/></li>
				</ol>
	    ...
	    <div class="nav" id="myid">	
		   <table id="testDataReqtable" class="hoverTable" style="width:100%;font-size: 12px;border:0; cellpadding:0; cellspacing:1;">
					<thead>
						<tr>
						  	<th align="center"><spring:message code="label.tds.testcaseno"/></th>
						    <th align="center"><spring:message code="label.tds.reqdescription"/></th>						  	
							<th align="center"><spring:message code="label.tds.functionality"/></th>	
							<th align="center"><spring:message code="label.tds.noofrecords"/></th>
							<th align="center"><spring:message code="label.tds.requesttype"/></th>						
							<th align="center"><spring:message code="label.tds.priority"/></th>
							<th align="center"><spring:message code="label.tds.estimatedtime"/></th>
							<th/>							
						</tr>
					</thead>
				 <tbody>
                    <tr onmouseover="this.style.cursor='pointer'">
                      ...
                      <td><input type="button" name="Add" id="add" value="<spring:message code="label.add"/> "></td>                                                                                     
                    </tr>                 
                </tbody>
			</table>							
		 </div>	
