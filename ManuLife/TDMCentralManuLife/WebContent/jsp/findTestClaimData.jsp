            ...
            <tbody>
              <tr>
                <td colspan="4" align="center" valign="middle">
                  <input type="submit" name="search" id="Search" class="btn-primary btn-cell" value="<spring:message code="label.submit"/>">
                  <input type="reset" value="<spring:message code="label.reset"/>" class="btn-primary btn-cell" onClick="clearFields('./testdaClaimUser');">                  
