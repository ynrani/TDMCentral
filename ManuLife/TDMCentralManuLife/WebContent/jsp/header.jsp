...
<section class="headerDiv">
	<header>
				...
				<nav>
					<ul>
						...
						<li id="tdm_life_cycle"><a id="tdm_life_cycle1"
							href="./index" class="active"><spring:message code="label.tdmlifecycle" /></a></li>
		...
		<section class="title-band">
			...
			<div class="advanced-search"><a href="./myReservationProp"><spring:message code="label.myReservation"/></a></div>
