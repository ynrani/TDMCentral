...
<jsp:include page="indexHeader.jsp"></jsp:include>
  <div class="container">
    <form:form id="dataChReqForm" name="dataChReqForm" action="./tdmChangeReqExt" modelAttribute="tdmChangeReqDTO">
	    ...
	    <li>&#x2f;</li>
	    <li class="active"><spring:message code="label.changerequest"/></li>
	  </ol>
  
      <h2 style="color: #0098cc"><spring:message code="label.changerequestdtl"/></h2>
      <hr>
      ...
      <div class="two-col">
        ...
        <tbody>
          <tr>
        	<td class="lable-title" width="20%" align="left" valign="middle"><spring:message code="label.requestid"/></td>
            <td class="flied-title" width="20%" align="left" valign="middle">
               <div style="color: #F40E0E;"><spring:message code="label.requeststartwith"/></div>
            	<br/>
            ...
            <td class="lable-title" width="20%" align="left" valign="middle" scope="col">
           		 <input type="submit" name="go" class="btn-primary btn-cell"  id="go" value="<spring:message code="label.go"/> "> 
