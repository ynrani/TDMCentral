...
<jsp:include page="indexHeader.jsp"></jsp:include>
  ...
  <div class="container">
    <form:form id="dataOnboardReqForm" name="dataOnboardReqForm" action="./tdmOnboardReq" modelAttribute="tdmOnboardReqDTO">
	    ...
	    <li>&#x2f;</li>
	    <li class="active"><spring:message code="label.onboard.request"/></li>
	    <c:if test="${reqId ne null}">
	    	<li>&#x2f;</li>
	    	<li style="font-size: 14px; color: #0098CC;"><spring:message code="label.dtm.requestid"/> : ${reqId}</li>
	    </c:if>
	  </ol>
  
      <h2 style="color: #0098cc"><spring:message code="label.onboard.requestdetails"/></h2>
      <hr>
      <div class="two-col">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="flied-title" align="left" valign="middle">
         	...
         	<td class="lable-title" align="left" valign="middle"><spring:message code="label.dt.applicationame" /><span>*</span> </td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
           ...
           <td class="lable-title" align="left" valign="middle"><spring:message code="label.dtm.applicationphase" /></td>
            <td class="flied-title" align="left" valign="middle">
          ...
          <tr>
            <td class="lable-title" align="left" valign="middle"><spring:message code="label.appdescription" /><span>*</span> </td>
            <td class="flied-title" align="left" valign="middle">
    ...
    <table style="width:100%;border:0; font-size: 13px; color: #0C5473;">
		<tr>
			<th class="lable-title" width="10%" style="font-size:14px; "><spring:message code="label.action" />Action</th>
			<th class="lable-title" width="30%" style="font-size:14px; "><spring:message code="label.dt.applicationame" />Application Name<span>*</span></th>
			<th class="lable-title" width="30%" style="font-size:14px; "><spring:message code="label.dt.database" />DataBase<span>*</span></th>
	   ...
	   <tbody class="tbodyContainer">
				...
				<td class="noWrapTxt algnRght" >
	  			<c:choose>
					<c:when test="${frRow==listSize}">
						<a href="javascript:;" class="sprite icon-add  addRow_ON_BOARD" id="tdgDataMaskingNoOfAppsDTOs"><spring:message code="label.add" /></a>
					</c:when>
					<c:otherwise>
						<a href="javascript:;" class="delRowFromDB_ON_BOARD sprite icon-delete" id="tdgDataMaskingNoOfAppsDTOs"><spring:message code="label.delete" /></a>
					</c:otherwise>
  				</c:choose>
        ...
        <table style="width:100%; border:0; font-size: 13px; color: #0C5473; cellpadding:4;">
          <tbody>
           <tr>
              <td class="lable-title" width="35%" align="left" valign="middle"><spring:message code="label.changerequestdes" /><span>*</span> </td>
              <td class="flied-title" width="20%" align="left" valign="middle">
		...
		<br/>
         <table style="width:100%; border:0; ">
            <tbody>
              <tr>
                  <th scope="col">
                    <input type="submit" name="submit" class="btn-primary btn-cell" value="<spring:message code="label.submit"/>"> 
                 </th>
               </tr>
            </tbody>
         </table>
