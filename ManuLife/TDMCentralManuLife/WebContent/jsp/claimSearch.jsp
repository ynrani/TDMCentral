                ...
                <tr>
                  <td colspan="4" align="center" valign="middle">
                   <input type="submit" name="search" id="Search" class="btn-primary btn-cell" value="<spring:message code="button.serch"/>">
                    <input type="reset" value="<spring:message code="label.reset"/>" class="btn-primary btn-cell" onClick="clearFields('./claimSearch');"/>
                  </td>
                </tr>
              </tbody>
            </table>
	              ...
	              <tbody>
	                ...
	                <tr>
	                  <td class="lable-title" align="left" valign="middle"><spring:message code="label.email.l1l2"/> 
	               		<input type="button" value="<spring:message code="label.email"/>"  class="btn-primaryemail btn-cellemail" onclick="popup('./popupEmail?result=${result}','L1/L2 Support','popup','popupOverlay','550');" />
                      </td>
	                </tr>
	              </tbody>
	            </table>
          ...
          <c:if test="${tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs ne null &&  not empty tdmPolicyClaimSearchDTO.tdmClaimSearchResultDTOs}">
            ...
            <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                      <input type="submit" name="reserve" class="btn-primary btn-cell" id="reserve" value="<spring:message code="button.reserve"/>">
