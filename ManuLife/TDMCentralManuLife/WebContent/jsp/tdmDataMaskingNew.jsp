 ...
 <div class="container">
  <c:if test="${error ne null}">
	  ...
	  <div class="three-step-container">
	      <div class="step1-active"><span class="step-number1">1</span><span class="step-heading"><spring:message code="label.dm.reqDtl"/></span></div>
       ...
       <c:when test="${readOnly eq null}">        
        <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                    <input type="submit" name="submit" class="btn-primary btn-cell" value="<spring:message code="label.saveandcontinue"/>"> 
                 </th>
               </tr>
            </tbody>
         </table> 
        ...
        <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                    <input type="submit" id="submit" name="submit" class="btn-primary btn-cell" value="<spring:message code="label.saveandcontinue"/>"> 
                 </th>
               </tr>
            </tbody>
         </table> 
         ...
         <c:otherwise>
           <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                    <input type="submit" id="submit"  name="submit" class="btn-primary btn-cell" value="<spring:message code="label.continue"/>"> 
                 </th>
               </tr>
            </tbody>
         </table> 
