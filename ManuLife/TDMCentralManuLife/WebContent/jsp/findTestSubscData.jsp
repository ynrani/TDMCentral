            ...
            <tbody>
              <tr>
                <td colspan="4" align="center" valign="middle">
                  <input type="submit" name="search" id="Search" class="btn-primary btn-cell" value=<spring:message code="button.search"/>>
                  <input type="reset" value="<spring:message code="label.reset"/>" class="btn-primary btn-cell" onClick="clearFields('./testdaSubscUser');">
                </td>
              </tr>
            </tbody>
          </table>
	              ...
	              <tbody>
	                ...
	                <tr>
	                  <td class="lable-title" align="left" valign="middle"><spring:message code="label.email.l1l2"/> 
	               		<input type="button" value="<spring:message code="label.email"/>" id="jqxButton" class="btn-primaryemail btn-cellemail" onclick="popup('./popupEmail?result=${result}','L1/L2 Support','popup','popupOverlay','550');"/>
                      </td>
	                </tr>
	              </tbody>
	            </table>
          ...
          <c:if test="${tDMSubscSearchDTO.tDMSubscSearchResultListDTOs ne null &&  not empty tDMSubscSearchDTO.tDMSubscSearchResultListDTOs}">
            ...
            <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                      <input type="submit" name="reserve" id="reserve" class="btn-primary btn-cell" value="<spring:message code="button.reserve"/>">
