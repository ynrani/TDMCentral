 ...
 <c:if test="${readOnly ne null}">
  ...
  <div class="container">
  	  ...
  	  <div class="three-step-container">
	      ...
	      <div class="step2-active"><span class="step-number2">2</span><span class="step-heading"><spring:message code="label.dm.preReqs"/></span></div>
	      <div class="step3"><span class="step-number3">3</span><span class="step-heading"><spring:message code="label.dm.dtl"/></span></div>
	   </div>
       ...
       <c:when test="${readOnly eq null}">               
        <table  style="width:100%; border:0;font-size: 13px; color: #0C5473;align:center;">
            <tbody> 
                 <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="back" class="btn-primary btn-cell" value="<spring:message code="label.back"/>"> 
                    <input type="submit" name="submit" id="savncont" class="btn-primary btn-cell" value="<spring:message code="label.saveandcontinue"/>"> 
        ...
        <table style="width:100%; border:0">
              <tbody>
                <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="SaveAndContinue" class="btn-primary btn-cell" value="<spring:message code="label.saveandcontinue"/>"> 
                 </th>
               </tr>
            </tbody>
         </table> 
         ...
         <c:otherwise>
           <table style="width:100%; border:0;align:center; ">
            <tbody>             
              <tr>
                  <th scope="col">
                    <input type="submit" name="submit" id="back2" class="btn-primary btn-cell" value="<spring:message code="label.back"/>">
                    <input type="submit" name="submit" id="contin" class="btn-primary btn-cell" value="<spring:message code="label.continue"/>"> 
                 </th>
               </tr>
            </tbody>
         </table> 
