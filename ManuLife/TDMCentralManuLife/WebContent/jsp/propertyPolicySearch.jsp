...
<body>
						...
						<tbody>
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										<spring:message code="label.propp.HO4" var="HO4"/>
										<spring:message code="label.propp.HO6" var="HO6"/>
										<spring:message code="label.propp.DP3" var="DP3"/>
										<spring:message code="label.propp.HO3" var="HO3"/>
										<form:option value=""><spring:message code="label.any"/></form:option>
										<form:option value="${HO4}"><spring:message code="label.propp.HO4"/></form:option>
										<form:option value="${HO6}"><spring:message code="label.propp.HO6"/></form:option>
										<form:option value="${DP3}"><spring:message code="label.propp.DP3"/></form:option>
										<form:option value="${HO3}"><spring:message code="label.propp.HO3"/></form:option>
									</form:select></td>
							...
							<tr>
								...
								<td class="flied-title" width="20%" align="left" valign="middle">
									<form:select path="policyState" id="policyState"
										class="down-control">
										<spring:message code="label.propp.UT" var="UT"/>
										<spring:message code="label.propp.AZ" var="AZ"/>
										<spring:message code="label.propp.IN" var="IN"/>
										<spring:message code="label.propp.OK" var="OK"/>
										<spring:message code="label.propp.CO" var="CO"/>
										<spring:message code="label.propp.IN" var="IN"/>
										<spring:message code="label.propp.CA" var="CA"/>
										<form:option value=""><spring:message code="label.any"/></form:option>
										<form:option value="${UT}"><spring:message code="label.propp.UT"/></form:option>
										<form:option value="${AZ}"><spring:message code="label.propp.AZ"/></form:option>
										<form:option value="${IN}"><spring:message code="label.propp.IN"/></form:option>
										<form:option value="${OK}"><spring:message code="label.propp.OK"/></form:option>
										<form:option value="${CO}"><spring:message code="label.propp.CO"/></form:option>
										<form:option value="${IN}"><spring:message code="label.propp.IN"/></form:option>
										<form:option value="${CA}"><spring:message code="label.propp.CA"/></form:option>
									</form:select>
								</td>
							...
							<tr>
								...
								<td class="flied-title" align="left"><form:select
										...
										<spring:message code="label.autop.policyterm4" var="policyterm4"/>
										<form:option value=""><spring:message code="label.any"/></form:option>
								...
								<td class="flied-title" class="flied-title" align="left"
									valign="middle"><label class="radio-inline"> <form:radiobutton
											path="addPayReq" id="addPayReq1" value="${yes}"/> <spring:message
											code="label.yes" /></label> <label class="radio-inline"> <form:radiobutton
											path="addPayReq" id="addPayReq2" value="${no}"/> <spring:message
											code="label.no" />
							...
							<tr>
								...
								<td class="flied-title" align="left" valign="middle"><form:select
										...
										<spring:message code="label.propp.CovA" var="CovA"/>
										<spring:message code="label.propp.CovC" var="CovC"/>
										<spring:message code="label.propp.CovD" var="CovD"/>
										<spring:message code="label.propp.CovE" var="CovE"/>
										<spring:message code="label.propp.CovF" var="CovF"/>
										<spring:message code="label.propp.DEDUCTIBLE" var="DEDUCTIBLE"/>
										<spring:message code="label.propp.UMB" var="UMB"/>
										<form:option value=""><spring:message code="label.any"/></form:option>
										<form:option value="${CovA}"><spring:message code="label.propp.CovA"/></form:option>
										<form:option value="${CovC}"><spring:message code="label.propp.CovC"/></form:option>
										<form:option value="${CovD}"><spring:message code="label.propp.CovD"/></form:option>
										<form:option value="${CovE}"><spring:message code="label.propp.CovE"/></form:option>
										<form:option value="${CovF}"><spring:message code="label.propp.CovF"/></form:option>
										<form:option value="${UMB}"><spring:message code="label.propp.UMB"/></form:option>
									</form:select></td>								
						   </tr>		
							<tr>
								<td class="lable-title" align="left"><spring:message
										...
										<spring:message code="label.y" var="yes"/>
										<spring:message code="label.n" var="no"/>
										<spring:message code="label.y" var="any"/>
								<td class="flied-title" class="flied-title" align="left"
									valign="middle"><label class="radio-inline"> <form:radiobutton
											path="addDocReq" id="addDocReq1" value="${yes}" /> <spring:message
											code="label.yes" /></label> <label class="radio-inline"> <form:radiobutton
											path="addDocReq" id="addDocReq2" value="${no}" /> <spring:message
											code="label.no" />
								</label> <label class="radio-inline"> <form:radiobutton
						...
						<tbody>
							<tr>
								...
								<input type="submit" name="reserve"
									class="btn-primary btn-cell" id="reserve" value="<spring:message
										code="button.reserve" />"></td>
							</tr>
						</tbody>
					</table>
 ...
 %>
					...
					<table style="width: 100%; border: 0">
						<tbody>
							<tr>
								<th scope="col"><input type="submit" name="reserve" id="reserve2" class="btn-primary btn-cell" value="<spring:message code="button.reserve"/>">
