...
public class TdmPolicyAutoPropSearchDAOImpl implements TdmPolicyAutoPropSearchDAO
{
	...
	public List<PolicySummaryStg> searchPolicyPropRecordsByPolicySearchNew(
			...
			throws DAOException {
		try {
			Properties props = AppLocaleConstant.getProperties(tdmPolicyPropertySearchDTO.getLocale());
			StringBuffer query = new StringBuffer("SELECT p FROM PolicySummaryStg p WHERE p.lob='"+props.getProperty("appconstant.home")+"'");
			...
			if (StringUtils.isNotEmpty(tdmPolicyPropertySearchDTO.getPolicyStage())) {
				if (tdmPolicyPropertySearchDTO.getPolicyStage().equalsIgnoreCase(props.getProperty("appconstant.active"))) {
					query.append(" AND p.policystatuscd='"+props.getProperty("appconstant.issued")+"' AND P.timedpolicystatuscd='"+props.getProperty("appconstant.inForce")+"' ");
				} else if (tdmPolicyPropertySearchDTO.getPolicyStage().equalsIgnoreCase(props.getProperty("appconstant.Cancelled"))) {
					query.append(" AND p.policystatuscd='"+props.getProperty("appconstant.Cancelled")+"' ");
				} else if (tdmPolicyPropertySearchDTO.getPolicyStage().equalsIgnoreCase("Pending")) {
					query.append(" AND p.policystatuscd in ("+props.getProperty("appconstant.policystatuscd")+")");
					query.append(" AND p.timedpolicystatuscd in ("+props.getProperty("appconstant.timedpolicystatuscd")+") ");
				}
			}
			// Risk State
	...
	public List<PolicySummaryStg> searchPolicyAutoRecordsByPolicySearchNew(
		...
		try {
			...
			Properties props = AppLocaleConstant.getProperties(tdmPolicyAutoSearchDTO.getLocale());
			StringBuffer query = new StringBuffer("SELECT p FROM PolicySummaryStg p WHERE p.lob='"+props.getProperty("appconstant.auto")+"'");
			...
			if (StringUtils.isNotEmpty(tdmPolicyAutoSearchDTO.getPolicyStage())) {
				...
				if (tdmPolicyAutoSearchDTO.getPolicyStage().equalsIgnoreCase(props.getProperty("appconstant.active"))) {
					query.append(" AND p.policystatuscd='"+props.getProperty("appconstant.issued")+"' AND P.timedpolicystatuscd='"+props.getProperty("appconstant.inForce")+"' ");
				} else if (tdmPolicyAutoSearchDTO.getPolicyStage().equalsIgnoreCase(props.getProperty("appconstant.Cancelled"))) {
					query.append(" AND p.policystatuscd='"+props.getProperty("appconstant.Cancelled")+"' ");
				} else if (tdmPolicyAutoSearchDTO.getPolicyStage().equalsIgnoreCase(props.getProperty("appconstant.Pending"))) {
					query.append(" AND p.policystatuscd in ("+props.getProperty("appconstant.policystatuscd")+")");
					query.append(" AND p.timedpolicystatuscd in ("+props.getProperty("appconstant.timedpolicystatuscd")+") ");
				}
			}
