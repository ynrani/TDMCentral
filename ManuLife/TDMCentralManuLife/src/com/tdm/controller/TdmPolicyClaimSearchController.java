...
public class TdmPolicyClaimSearchController
{
	...
	public String findTestDataBack(
		...
		try {
			...
			if (null != tdmPolicyClaimSearchDTO1) {
				...
				model.addAttribute(AppConstant.RESULT, getSearchCriteria(tdmPolicyClaimSearchDTO,request));
	 ...
	 * @return
	 */
	public String getSearchCriteria(TdmPolicyClaimSearchDTO tdmPolicyClaimSearchDTO,HttpServletRequest request) {
