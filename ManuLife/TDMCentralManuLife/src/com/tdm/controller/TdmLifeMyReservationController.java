	...
	public String myReservationRecordAuto(
		...
		try {
			...
			TdmPolicyAutoSearchDTO tdmPolicyAutoSearchDTO = tdmMyReservationService
					.getReservedRecordForUser(UserId, offSet, recordsperpage, true, localeResolver.resolveLocale(request).getLanguage());
	...
	public String myReservationRecordProperty(
		...
		try {
			...
			TdmPolicyPropertySearchDTO tdmPolicyPropertySearchDTO = tdmMyReservationService
					.getReservedRecordForUserProperty(UserId, offSet, recordsperpage, true, localeResolver.resolveLocale(request).getLanguage());
