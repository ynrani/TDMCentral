...
public class SearchPolicyPropListExcelView extends AbstractExcelView
{
	...
	protected void buildExcelDocument(Map<String, Object> model, HSSFWorkbook workbook,
		...
		setExcelHeader(excelSheet, style,request);
	...
	public void setExcelHeader(HSSFSheet excelSheet, HSSFCellStyle style,HttpServletRequest request) {
		HSSFRow excelHeader = excelSheet.createRow(2);

		System.out.println(request.getLocale().getLanguage());

		//Locale locale= localeResolver.resolveLocale(request);
		Properties props= AppLocaleConstant.getProperties(request.getLocale().getLanguage());
		excelSheet.setDisplayGridlines(false);

		excelHeader = excelSheet.createRow(2);
		excelHeader.createCell(0).setCellValue(props.getProperty("lable.userid"));

		excelHeader = excelSheet.createRow(4);
		excelHeader.createCell(2).setCellValue(props.getProperty("label.policy.policyNo"));
		excelHeader.createCell(3).setCellValue(props.getProperty("label.policy.prodType"));
		excelHeader.createCell(4).setCellValue(props.getProperty("label.policy.stage"));
		excelHeader.createCell(5).setCellValue(props.getProperty("label.policy.state"));
		excelHeader.createCell(6).setCellValue(props.getProperty("label.policy.term"));
		excelHeader.createCell(7).setCellValue(props.getProperty("label.policy.effDt"));
		excelHeader.createCell(8).setCellValue(props.getProperty("label.policy.expDt"));
		...
		excelHeader.createCell(9).setCellValue(props.getProperty("label.policy.avlPays"));
		excelHeader.createCell(10).setCellValue(props.getProperty("label.policy.avlDocs"));
		excelHeader.createCell(11).setCellValue(props.getProperty("label.policy.scenario"));
		/*
		 * 
		...
		excelHeader.createCell(0).setCellValue(props.getProperty("label.tcId"));
		excelHeader.createCell(1).setCellValue(props.getProperty("label.tcName"));
