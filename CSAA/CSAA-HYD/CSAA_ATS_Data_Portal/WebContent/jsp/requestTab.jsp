			...
			<div class="main-content">
				<div class="request-header">
					...
					<ul class="nav nav-tabs data-gen-tabs" role="tablist" id="request-tab">
						...
						<button id="btnNewRequest"
							class="new-policy-text new-request-link-style"
							title="New Data Creation Request">New Data Generation</button>
