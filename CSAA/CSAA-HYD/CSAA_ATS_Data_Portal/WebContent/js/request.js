			...
			.DataTable(
					{
						...
						"columnDefs" : [
								...
								},
								{
									"targets" : 1,
									"width" : "50px",
									"defaultContent" : "<select id='ddlRiskState' class='table-cell-input'><option selected='selected' value='Any'>Any</option></select>"
								},
								{
									"targets" : 2,
									"width" : "61px",
									"defaultContent" : "<select id='ddlPaymentPlan' class='table-cell-input'><option selected='selected' value='Any'>Any</option></select>"
								},
								{
									"targets" : 3,
									"width" : "72px",
		...
		.DataTable(
				{
					...
					"columnDefs" : [
							...
							},
							{
								"targets" : 1,
								"width" : "51px",
								"defaultContent" : "<select id='ddlPolicyType' class='table-cell-input'><option selected='selected' value='Any'>Any</option></select>"
							},
							{
								"targets" : 2,
								"width" : "59px",
								"defaultContent" : "<select id='ddlPropertyRiskState' class='table-cell-input'><option selected='selected' value='Any'>Any</option></select>"
							},
							{
								"targets" : 3,
								"width" : "75px",
								"defaultContent" : "<select id='ddlPropertyPaymentPlan' class='table-cell-input'><option selected='selected' value='Any'>Any</option></select>"
							},
							{
								"targets" : 4,
								"width" : "79px",
