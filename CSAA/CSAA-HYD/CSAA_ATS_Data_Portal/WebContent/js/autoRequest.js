...
$(document).ready(function() {
	...
	function initialize()
	{
		...
		$("#txtApprover").val('Arun');
		$("#ddlAssignedTo > [value='None']").attr("selected", "true");
		$("#ddlStatus > [value='None']").attr("selected", "true");
		$("#ddlFullFilled > [value='Auto']").attr("selected", "true");
		//$("#txtStatusChangeDescription").val('Status is changed due to policy');
	...
	{
		var ffArr = [ {key:'Auto', value:'Auto'},{key:'Manual', value:'Manual'}];
		$.each(ffArr, function(index, valueProp) {

			 $('#ddlFullFilled').append($('<option>').text(valueProp.key).attr('value', valueProp.value));
		});
		
		var grpArr = [ {key:'None', value:'None'},{key:'Jack', value:'Jack'}, {key:'Bill',value:'Bill'}, {key:'Hilery', value:'Hilery'}, {key:'Donald', value:'Donald'}];
		...
		//fill Priority
		var priorityArr = [ {text:'Normal',value:'Normal'},{text:'Medium', value:'Medium'}, {text:'High', value:'High'}, {text:'Critical', value:'Critical'}];
		$.each(priorityArr, function(index, valueProp) {
			 $('#ddlPriority').append($('<option>').text(valueProp.text).attr('value', valueProp.value));
		});
		
		//fill Data Source
		var dataSourceArr = [ {text:'PAS',value:'PAS'}];
		$.each(dataSourceArr, function(index, valueProp) {
			 $('#ddlDataSource').append($('<option>').text(valueProp.text).attr('value', valueProp.value));
		});
		
		//fill Environment
		var EnvironmentArr = [ {text:'--Select--',value:'--Select--'},{text:'PAS-EP2',value:'EP2'},{text:'PAS-BF', value:'BF'}];
		$.each(EnvironmentArr, function(index, valueProp) {
			 $('#ddlEnvironment').append($('<option>').text(valueProp.text).attr('value', valueProp.value));
		});
	}
    ...
    $('#autoPolicyTable').DataTable( {
		...
		"columnDefs": [ 
													...
													},
													{
														...
														"defaultContent" : "<select id='ddlRiskState' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 3,
													...
													},
													{
														...
														"defaultContent" : "<select id='ddlNoDrivers' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 6,
														
														"defaultContent" : "<select id='ddlVechicles' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 7,
														
														"defaultContent" : "<select id='ddlPaymentPlan' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													}
													]
    } );
	...
	function fillAutoRow(rowId)
	{
		...
		$.each(AutoCountryList, function(index, valueProp) {
			 $('#autoPolicyTable tbody tr[id="'+rowId+ '"] #ddlRiskState').append($('<option>').text(valueProp).attr('value', index));
		});
		
		//fill Payment Plan
		
		$.each(paymentPlan, function(index, valueProp) {
			 $('#autoPolicyTable tbody tr[id="'+rowId+ '"] #ddlPaymentPlan').append($('<option>').text(valueProp).attr('value', index));
		});
		
		//fill Data Source
		var noDriversArr = [ {text:'1',value:'1'},{text:'2', value:'2'}, {text:'3', value:'3'}, {text:'4', value:'4'}, {text:'5', value:'5'}, {text:'6', value:'6'}, {text:'7', value:'7'}];
		...
		//fill Environment
		var noVehiclesArr = [ {text:'1',value:'1'},{text:'2', value:'2'}, {text:'3', value:'3'}, {text:'4', value:'4'}, {text:'5', value:'5'}, {text:'6', value:'6'}, {text:'7', value:'7'}];
	...
	$('#propertyPolicyTable').DataTable( {
		...
		"columnDefs": [ 
													...
													},
													{
														...
														"defaultContent" : "<select id='ddlPolicyType' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 4,
														
														"defaultContent" : "<select id='ddlPropertyRiskState' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 5,
														
														"defaultContent" : "<select id='ddlPropertyPaymentPlan' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 6,
														
														"defaultContent" : "<select id='ddlMortgagee' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													},
													{
														"targets" : 7,
														
														"defaultContent" : "<select id='ddlInterest' class='table-cell-input-auto'><option selected='selected' value='Any'>Any</option></select>"
													}]
    } );
	...
	function fillPropertyRow(rowId)
	{
		...
		var mortgagee = [ {text:'Yes',value:'Yes'},{text:'No',value:'No'}];
		...
		var Interest = [ {text:'Yes',value:'Yes'},{text:'No',value:'No'}];
