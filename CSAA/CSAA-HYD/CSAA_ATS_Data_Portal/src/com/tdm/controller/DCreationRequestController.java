	...
	private TDMDataCreationDTO populateDataGenarationForm(
		...
		try {
			...
			requestData = dataRequestService
					.saveServiceRequestData(requestDataDTO, Boolean.FALSE);
	...
	public void genarateScenarioDropDownValues( ModelMap model ) throws JSONException
	{
		...
		JSONArray jsonObjjPropertyPaymentPlan = new JSONArray();
		  for(Object object :autoList)
		  {
			  ...
			  jsonObjAutoCountry.put(fieldListDTO.getValueCode(),fieldListDTO.getListValue());		
		  ...
		  {
			  FieldListDTO fieldListDTO=(FieldListDTO)object;
			  if(!(fieldListDTO.getListValue()).equals("Any") || !(fieldListDTO.getValueCode()).equals("Any"))
		  ...
		  {
			  FieldListDTO fieldListDTO=(FieldListDTO)object;
			  jsonObjjPropertyPolicyType.put( fieldListDTO.getValueCode(), fieldListDTO.getListValue());
		  ...
		  {
			  FieldListDTO fieldListDTO=(FieldListDTO)object;
			  jsonObjjPropertyRiskState.put( fieldListDTO.getValueCode(), fieldListDTO.getListValue());
