...
public class MyReservationPropPolicyExcelView extends AbstractExcelView{
	...
	public void setExcelHeader(HSSFSheet excelSheet, HSSFCellStyle style) {
		...
		excelHeader.createCell(4).setCellValue("Risk  State");
	...
	public void setExcelRows(HSSFSheet excelSheet,
		...
		for (TdmPolicyPropertySearchResultDTO tdmPolicyPropertySearchResultDTO : searchPolicyPropOutputList) {
			...
			excelRow.createCell(5).setCellValue(tdmPolicyPropertySearchResultDTO.getExpairDate());
			excelRow.createCell(6).setCellValue((tdmPolicyPropertySearchResultDTO.getTotalDue()==null?0D:Double.valueOf(tdmPolicyPropertySearchResultDTO.getTotalDue())));
