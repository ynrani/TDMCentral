...
public class TDMAdminServiceImpl extends TdmBaseServiceImpl implements TDMAdminService
{
	...
	public boolean saveUserDetails(TdmUserDTO userdo, boolean bEdit) throws ServiceException {
		...
		try {
			...
			boolean str = tDMAdminDAO.saveUserDetails(
	...
	public boolean validateUserId(String userid) throws ServiceException {
		logger.info(MessageConstant.TDM_ADMIN_SERVICE + MessageConstant.TDM_ADMIN_VALIDATE_USER
				+ MessageConstant.LOG_INFO_PARAMS_NO);
		try {
			EntityManager managerUser =openCsaaUserEntityManager();// openUserEntityManager();
	...
	public List<TDMDataCreationDTO> getRequestByUserId(String userId,String userRole, int offSet, int recordsperpage, boolean b) throws ServiceException {
		...
		try {
			...
			List<TDMDataCreationDTO> requestList = tdmUserMapper
					.convertServiceRequestDOToTDMDataCreationListDTO(tDMAdminDAO
							.getRequestByUserId(userId,userRole, managerUser,offSet, recordsperpage,
									b));
			
			//List<ServiceRequestDO> listRequest = (List<ServiceRequestDO>) managerUser.find(ServiceRequestDO.class, userId);
			closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE + MessageConstant.TDM_ADMIN_GET_EDIT_USER
					+ MessageConstant.LOG_INFO_RETURN);
			return requestList;
	...
	public List<TDMDataCreationDTO> getAllRequest(int offSet, int recordsperpage, boolean b) throws ServiceException {
		...
		try {
			EntityManager managerUser = openUserEntityManager();
			List<TDMDataCreationDTO> listRequest = tdmUserMapper
					.convertServiceRequestDOToTDMDataCreationListDTO(tDMAdminDAO
							.getAllRequest(managerUser,offSet, recordsperpage,b));
			closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE + MessageConstant.TDM_ADMIN_GET_EDIT_USER
					+ MessageConstant.LOG_INFO_RETURN);
			return listRequest;
	...
	public Long getReqByUserIdRecordCount(String userId) throws ServiceException {
		...
		try {
			EntityManager managerUser = openUserEntityManager();
			Long cnt = tDMAdminDAO.getReqByUserIDRecordsCount(userId, managerUser);
			closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE
					+ MessageConstant.TDM_ADMIN_SEARCH_USER_COUNT + MessageConstant.LOG_INFO_RETURN);
			return cnt;
	...
	public Long getReqRecordCount() throws ServiceException {
		...
		try {
			EntityManager managerUser = openUserEntityManager();
			Long cnt = tDMAdminDAO.getReqRecordsCount(managerUser);
			closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE
					+ MessageConstant.TDM_ADMIN_SEARCH_USER_COUNT + MessageConstant.LOG_INFO_RETURN);
			return cnt;
	...
	public String getLastLoginTime(String userId) throws ServiceException {
		...
		try {
			...
			String loginTime = tDMAdminDAO.getLastLoginTime(userId, managerUser);
			//closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE + MessageConstant.TDM_ADMIN_GET_USER_ROLE
					+ MessageConstant.LOG_INFO_RETURN);
			return loginTime;
	...
	public String updateLoginTime(String userId,String lastLogin) throws ServiceException {
		...
		try {
			...
			String loginTime = tDMAdminDAO.updateLoginTime(userId,lastLogin, managerUser);
			//closeUserEntityManager(managerUser);
			logger.info(MessageConstant.TDM_ADMIN_SERVICE + MessageConstant.TDM_ADMIN_GET_USER_ROLE
					+ MessageConstant.LOG_INFO_RETURN);
			return loginTime;
	...
	public String checkUserAvailability(String userId) throws ServiceException { 
			EntityManager managerUser = openUserEntityManager();
			 String	 strMsg=tDMAdminDAO.checkUserAvailability(userId,managerUser);
		return strMsg;
	}
	...
	public String checkEmailAvailability(String emailId) throws ServiceException { 
		EntityManager managerUser = openUserEntityManager();
		 String	 strMsg=tDMAdminDAO.checkEmailAvailability(emailId,managerUser);
	return strMsg;
}
