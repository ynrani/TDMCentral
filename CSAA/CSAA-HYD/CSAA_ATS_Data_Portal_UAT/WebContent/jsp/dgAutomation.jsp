				...
				<div class="main-content">
					<div class="request-header">
						...
						<div class="auto-basic-desc-style">
								<div style='display:inline;'><i class="fa fa-wrench ser-pic"></i></div>
								<div style='display:inline-block;padding:10px'>Through data generation service consumers can raise request to create test data in the required environment.</br> The below scenarios represent commonly requested policy types. Don't find the scenario matching your test data requirement? </br>Please click on "Customized-Data generation" to raise your test data generation request.</div>
						</div>
						<!-- Nav tabs -->
						<ul class="nav nav-tabs" role="tablist" id="request-tab">
							<li role="presentation" class="active">
								<a data-target="#manual" aria-controls="manual" role="tab" data-toggle="tab">
									<i class="fa fa-database csaa-vectors"></i>Data Request
								</a>
							</li>
						<!-- 	<li role="presentation">
							...
							<li role="presentation"> 
								<a  href="./dgActivityLog?requestId=${requestDataDTO.requestId}">
						
								
								<i class="fa fa-history fa-lg csaa-vectors"></i>Request Activity Log</a>
							...
							<div class="content-section">
															...
															<td class="flied-title" width="25%" align="left"
																valign="middle">
																	<div class='input-group date' id='datetimepicker1'>
																		...
																		class="form-control date-control-style expected-date-width dateHigherThanToday" required="true" />
								...
								<%-- </form:form>  --%>
										...
										<div class="details-table details-extended">
											<div class="collpasewidget active policy-container-style" id="autoPolicyContainer">
												<div class="widget-inner policy-widget-style" id="autoWidgetDiv">
													<div class="policy-title"><span class ="toolbar-btn-style normal-cursor" style="float:left"> <i class="fa fa-car car-size-style icon-size-auto"> </i> Auto Policy</span></div>
													<div id="autoPolicyContent" class="widget-content policy-content">
														<div id="autoScenario" class="scenario-style hide-class">
														  <c:forEach  var="autoScenarioitem"
																...
																<div class="col-md-4 scenario-chk scenario-column scenario-col-border">
																<label class="scenario-chk-label-style">
																<c:if test='${autoScenarioitem.isActive == true}'>
																<input type="checkbox" id="autoScenarioType" name="autoScenarioType" class="chk-control large-ticks" value="${autoScenarioitem.scenarioId}"/>
																</c:if>
																<span>${autoScenarioitem.description}<i class="fa fa-question-circle question-tooltip-style question-tooltip" data-toggle="tooltip" title="${autoScenarioitem.description}"></i></span>
																</label>
																</div>
														...
														<hr class="hr-style">
														<table id="autoPolicyTable" class="customDataTable" cellspacing="0" width="100%">
															<thead>
															<tr>
											...
											<div class="collpasewidget active policy-container-style" id="propertyPolicyContainer">
												<div class="widget-inner policy-widget-style"  id="propertyWidgetDiv">
													<!--<div class="policy-title"><div class="prop-title-style"><i class="fa fa-minus-square-o plus-minus-style" title="Expand/Collpase Details"></i> Property Policy</div></div>-->
													  <div class="policy-title"><span class ="toolbar-btn-style normal-cursor" style="float:left"><i class="fa fa-home icon-size-auto"></i> Property Policy</span>
													  </div>
													<div id="propertyPolicyContent" class="widget-content">
														...
														<div id="propertyScenario" class="scenario-style hide-class">
														...
														<c:forEach  var="propertyScenarioitem"
																...
																<div class="col-md-4 scenario-chk scenario-column scenario-col-border">
																<label class="scenario-chk-label-style">
																<c:if test='${propertyScenarioitem.isActive == true}'>
																<input type="checkbox" name="propertyScenarioType" class="chk-control large-ticks" value="${propertyScenarioitem.scenarioId}"/>
																</c:if>
																<span>${propertyScenarioitem.description}<i class="fa fa-question-circle question-tooltip-style question-tooltip" data-toggle="tooltip" title="${propertyScenarioitem.description}"></i></span>
																</label>
																</div>
															...
															<hr class="hr-style">
														<table id="propertyPolicyTable" class="customDataTable" cellspacing="0" width="100%">
															<thead>
															<tr>
												...
												<div class="container-fluid extra-cont-style">
													<div class="row">
														<div class="col-xs-12 other-container-style">
															...
															<!--<div class="request-dash-bar"></div>-->
															<div><textarea class="dialog-text-area" ></textarea></div>
														</div>
													</div>
												</div>
										</div>
											...
											<div class="container-fluid extra-cont-style">
												<div class="row">
													<div class="col-xs-12 new-scenario-question-style">
														<span class="test-title extra-title-style">Customized-Data generation</span>
														<!--<div class="request-dash-bar"></div>-->
														<p class="new-sce-text">Don't find the scenario matching your test data requirement? Please click on "Customized-Data generation" to raise your test data generation request.</p>
												<input id="btnNewSchenario" type='button' class="new-sce-btn ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover new-scenario-btn-text" value="Customized-Data generation" title="Generate new scenario manually">
													</div>
												</div>
											</div>
										</div>
									...
									<div class="btn-container">
										<button type="submit" id="btnSave" value="save" name="save" class="leftButton ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only ui-state-hover submit-btn-style" title="Save Request">
										...
										<input type="hidden"  value="" id="autoPolicye" name="auto" />
										<input type="hidden"  value="" id="propPolicye" name="prop" />
										...
										<div class="container-fluid extra-cont-style">
											<div class="row">
												<div class="col-xs-12 new-scenario-question-style">
													...
													<input type="button" value="Generate Test Data Templates" id="btnGenerateTemplate" class="generate-template-btn btn btn-primary" title="Generate Templates"/>
													<ul class="template-style">
													<li><span>Run Manager</span>
														<!--  -->
    													<a href="./downloadRunManagerExcel?runManagerExcelFile=${requestDataDTO.requestId}" onclick="downloadRunManagerExcel()"><i class='fa fa-download upload-download-style' title="Download"></i></a>
    													<a href="javascript:void(0)" class="input-link"><i class='fa fa-upload upload-download-style' title="Upload"></i></a>
    													<div class="input-group hide-class">
											                 <input type="text" id="txtRunManager" class="form-control file-upload-style" readonly>
											                <span class="input-group-btn" style='display:inherit'>
											                    <span class="btn btn-primary btn-file">
											                        Browse&hellip; <input type="file" id="runManagerFile">
	
											                    </span>
											                    <input type="button" id="btnRunManager" value="Upload" class="btn btn-primary hide-class" />
											                </span>
											            </div>
											            <div id="runManagerCompleteMsg" class="table-error complete-msg-info" style="display:none;">File uploaded successfully</div>
													</li>
													<li><span>Auto Policy Test Data</span>
														<a href="./downloadAutoExcel?runManagerExcelFile=${requestDataDTO.requestId}" onclick="downloadRunManagerExcel()"><i class='fa fa-download upload-download-style' title="Download"></i></a>
    													<a href="javascript:void(0)" class="input-link"><i class='fa fa-upload upload-download-style' title="Upload"></i></a>
    													<div class="input-group hide-class">
											                 <input type="text" id="txtAutoPolicytestData" class="form-control file-upload-style" readonly>
											                <span class="input-group-btn" style='display:inherit'>
											                    <span class="btn btn-primary btn-file">
											                        Browse&hellip; <input type="file" id="autoPolicytestDataFile">
	
											                    </span>
											                    <input type="button" id="btnAutoPolicytestData" value="Upload" class="btn btn-primary" />
											                </span>
											                
											            </div>
											            <div id="autotestCompleteMsg" class="table-error complete-msg-info" style="display:none;">File uploaded successfully</div>
													</li>
													<li><span>Property Policy Test Data</span>
														<a href="./downloadPropertyExcel?runManagerExcelFile=${requestDataDTO.requestId}" onclick="downloadRunManagerExcel()"><i class='fa fa-download upload-download-style' title="Download"></i></a>
														<a href="javascript:void(0)" class="input-link"><i class='fa fa-upload upload-download-style' title="Upload"></i></a>
    													<div class="input-group hide-class">
											                 <input type="text" id="txtPropPolicytestData" class="form-control file-upload-style" readonly>
											                <span class="input-group-btn" style='display:inherit'>
											                    <span class="btn btn-primary btn-file">
											                        Browse&hellip; <input type="file"  id="propPolicytestDataFile">
	
											                    </span>
											                    <input type="button" id="btnPropPolicytestData" value="Upload" class="btn btn-primary" />
											                </span>
											                
											            </div>
											            <div id="proptestCompleteMsg" class="table-error complete-msg-info" style="display:none;">File uploaded successfully</div>
													</li>
													</ul>
													</p>
												</div>
...
<!-- 	<script type="text/javascript" src="js/request.js"></script> -->
	...
	<script>
		...
		var count = 0;
		var serviceType = 'Data Generation Automation';
   ...
   if(status=="")
	   {
	   document.getElementById('createdOn').value = '${createdDate}';
	   }
