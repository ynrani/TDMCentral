 ...
 %>
				...
				<c:if
					...
					<div class="scrollingX" id="myid">
						...
						<!-- <a id="myHeader" class="hrefVisited" href="javascript:toggle2('myContent','myHeader');"> Show Advance Search
								</a> -->
					</div>
						...
						<tbody>
							<tr>
								<th scope="col" class="buttonsAll15"><input type="submit"
									...
									type="submit" name="export" id="export" value="Export to Excel">
									<a id="myHeader" class="hrefVisited"
									href="javascript:toggle2('myContent','myHeader');"> Show
										Advance Search </a></th>
							</tr>
						</tbody>
					</table>
					...
					<table class="table "
						...
						<tr>
							...
							<c:forEach items="${reservedTestDataListPerUser}"
								...
								<tr>
									<td>${reservedTestData.sno}</td>
									<td>${reservedTestData.userId}</td>
									<td>${reservedTestData.noOfRecordsResvByUser}</td>
