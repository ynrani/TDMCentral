	...
	<header>
		...
		<section class="navigation">
			...
			<div class="main-nav">
				<div id="cssmenu">
					<ul>
					<c:if test="${session.getAttribute("ROLE") != "ROLE_ADMIN" }">
					{
			<script type="text/javascript">
				<%-- 	<% if(session.getAttribute("ROLE") != AppConstant.ROLE_USER){ %> --%> --%>
		  <sec:authorize access="hasRole('ROLE_ADMIN','ROLE_TDMADMIN')"> 
						...
						<li id="services"><a href="#" >Services</a>
							<ul>
								...
								<li id="services_subsetting"><a href="./tdmDataMaskingNew">Data Subsetting </a></li>
								...
								<li id="services_PASDataRequest"><a href="./requestData">PAS Data Request </a></li>
									<li id="services_MyRequest"><a href="./landing">My Request</a></li>
								<li id="services_ftd"><a href="#">Find Test Data</a>
									
									
									<ul>
										<li id="services_ftd_insu"><a href="#">ATS Data Search</a>
											<ul>
												
														<li id="services_ftd_insu_pc_ftd"><a href="./policyATSSearch">FTD</a></li>
								...
								<li id="admin_db_refresh"><a href="./DataRefreshNew" >Data Refresh</a></li>
								<p id="ajaxcontent"></p>
