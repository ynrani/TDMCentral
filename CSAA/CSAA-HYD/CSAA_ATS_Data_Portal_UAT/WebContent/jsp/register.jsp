					...
					<p>
						<%
							if (request.getParameter("userName") !=null 
										...
										&& request.getParameter("consumerGroup") != null
										&& request.getParameter("manager") != null
										&& request.getParameter("accessReason") != null) {
									out.println("e");
								}
						...
						<script>
						var userRole ='<%=(String) request.getSession().getAttribute("DBUSERID")%>';
						
					</script>
						
						 <script>
						var userRole ='<%=(String) request.getSession().getAttribute("userId")%>';
