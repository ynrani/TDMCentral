			...
			<div class="main-content">
				<div class="request-header">
					...
					<div class="auto-basic-desc-style">
								...
								<div style='display:inline-block;padding:10px'>Congratulations!  Now your test data is just a click away. Welcome to the Automation data generation request screen.</br> Please select the scenarios from the list to create the test data.
								</div>
					</div>
					<!-- Nav tabs -->
