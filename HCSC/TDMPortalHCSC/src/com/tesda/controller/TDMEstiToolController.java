...
/**
 * Controller class which will provides the information about TDM and TDP
 * estimation tools. Handles the requests in order to download TDM and TDP
 * estimation tool templates in zip format.
 */
...
public class TDMEstiToolController
{
	...
	@RequestMapping(TDMConstants.MAP_TDP_SENSITIVE_PROFILER)
	public String sensitiveProfiler()
	{
		return TDMConstants.TDP_SESITIVE_PROFILER;
	}
