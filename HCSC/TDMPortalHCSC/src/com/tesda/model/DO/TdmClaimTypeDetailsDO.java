 ...
 */
@Entity
@Table(name = TDMConstants.CLAIM_TYPE_DETAILS_TABLE)
...
public class TdmClaimTypeDetailsDO implements Serializable
{
	...
	public TdmSubscriberDetailsDO getTdmSubscrDtls()
	{
		return tdmSubscrDtls;
	}

	public void setTdmSubscrDtls(TdmSubscriberDetailsDO tdmSubscrDtls)
	{
		this.tdmSubscrDtls = tdmSubscrDtls;
	}
