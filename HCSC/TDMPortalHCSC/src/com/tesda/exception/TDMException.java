...
/**
 * TDMException is a base exception class for ServiceException and DAOException
 * classes.
 */
...
public class TDMException extends Exception
{
	...
	/**
	 * Constructor with error code and error message. NOTE: ErrorCode and
	 * ErrorMessage are to carry sufficient error information upto UI.
	 * 
	 * @param errorCode
	 * @param errorMessage
	 */
