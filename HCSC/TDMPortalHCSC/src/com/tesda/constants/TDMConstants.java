...
public final class TDMConstants
{
	...
	public static final String MAP_TDMNS_EXPORT = "/tdmNonStandExport";
	...
	// File downloads
	public static final String FILE_USER_MANUAL = "/downloads/TDM Portal Tool_User Guide_v3.2_April 2016.pdf";
	...
	public static final String ID_EXIST = " user id already exists.";
	...
	public static final String PREM = "PREM - Premium";
	...
	public static final String FUNDING_IND = "FUNDING INDICATOR";
	public static final String PBM = "PHARMACY BENEFIT MANAGER";
	...
	public static final String MEDICAL_ONLY = "Medical Only";
	public static final String DENTAL = "Dental";
	public static final String DENTAL_ONLY = "Dental Only";
	public static final String VISION = "Vision";
	public static final String VISION_ONLY = "Vision Only";
	public static final String BLENDED = "Blended";
	public static final String PRESCRIPTION = "Prescription";
	public static final String PRESCRIPTION_RX = "Prescription(Rx)";
	public static final String PRESCRIPTION_RX_ONLY = "Prescription(Rx) Only";
	...
	public static final String SUB_ACTIV_CANCEL_DEPN = "Subscriber - Active with Cancelled Dependent(s)";
	public static final String SUB_CANCEL_CANCEL_DEPN = "Subscriber - Cancelled with Cancelled Dependent(s)";
	public static final String SUB_CANCEL_CANCEL_SPOUSE = "Subscriber - Cancelled with Cancelled Spouse";
	public static final String GROUP = "Group";
	public static final String PPO = "PPO";
	public static final String MALE = "Male";
	public static final String FEMALE = "Female";
	public static final String STATE_MT = "Montana(MT)";
	public static final String STATE_NM = "NewMexico(NM)";
	...
	public static final String MMDDYYYY_HHMMSS = "MM-dd-yyyy hh:mm:ss a zzz";
	public static final String MMDDYYYY_HH_MM_SS = "MM-dd-yyyy HH:mm:ss";
	public static final String dd_MM_yyyy = "dd-MM-yyyy";
