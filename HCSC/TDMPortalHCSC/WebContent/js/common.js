...
$.fn.center = function (){
	...
	intH2=parseInt(intH);
	this.css("top", (((intH2 - this.outerHeight()) / 2) -100) + "px");
...
function confirmation_dialogl1l2Support(title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
...
function confirmation_dialogYNDeleteUser(userId,title,msg,w,popType,caption1,caption2){
	var objPop = $("#popup"), popTitle = $('#popTitle'), objOverLay = $("#popupOverlay"), objContnt = $("#popup_content");
	var popW= (w)? w : 500;
	objContnt.html('');
	popTitle.html(title);
	...
	if (popType == 'YesNo'){
		...
		objContnt.append('<div class="ynpopup_button">'+
                '<input type="button" value="'+yesCaption+'" id="'+userId+'" class="btn-popup" onclick="submitDeleteUser(this.id);"/><input type="button" class="btn-popup" value="'+noCaption+'" onclick="hidePopup(\'popup\',\'popupOverlay\')"/></div>');
	}
	...
	$.ajax({
		type:'POST',
			...
			success: function( data ) {
				confirmation_dialogl1l2Support('Success Message','Email sent to Administrator to process the request.' ,400,'Ok','','');
			},
			error:function(jqXHR,error, errorThrown){
