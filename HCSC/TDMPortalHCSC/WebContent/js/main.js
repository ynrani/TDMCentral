...
function forgotPasswordValidation(){
 ...
 function tdgDataMaskingValidationPage3(){
		...
		formObj1.validate({
		     ...
		     submitHandler: function(form) {
		    	 confirmation_dialogYNMR('Submit','Are you sure you want to submit ?',400,'YesNo','Yes','No');
 ...
 function tdmOnboardingReqVali(){
		...
		formObj1.validate({
		     ...
		     submitHandler: function(form) {
		       confirmation_dialogYN('Submit','Are you sure you want to submit ?',400,'YesNo','Yes','No');
	...
	$.ajax({
		type:'POST',
			...
			success: function( data ) {
				   if(data == 'true')
					{
					  confirmation_dialog_forward(forwardUrl,'Message', "User Id "+userId+" successfully deleted."  ,400,'Ok','','');
					}			     	
			     	else
			     	{
			     		confirmation_dialog('Error Message', "Unable to do requested operation."  ,400,'Ok','','');
