				...
				<nav>
					<ul>						
						<li id="tdm_life_cycle"><a id="tdm_life_cycle1"
							href="./index" class="active">TDM Portal Functions</a></li>
		...
		<section class="title-band">
			...
			<div class="quicklink-container">
				...
				<div class="quicklink-list">
					<ul>
						<li><a href="http://10.130.160.40/SensitivityProfiler/" TARGET="_NEW">Sensitivity Profiler</a></li>
						...
						<li><a href="./testdaUser">Test Data Search</a></li>
						<li><a
