 			...
 			%>
						...
						<ul class="grdPagination">
							<%
											...
											if (currentPage != 1) {
			   							%>
							<li><a href="tdmOnBoardingDashBoardCR?page=<%= 1 %>">First</a>
								<div>First</div></li>
							<li><a
								href="tdmOnBoardingDashBoardCR?page=<%= currentPage-1 %>">&lt;
									Prev</a>
								<div>&lt; Prev</div> <%
			   								} else {
			   								 	if(noOfPages > 1) {
			   							%>
							<li class="disable"><a
								href="tdmOnBoardingDashBoardCR?page=<%= 1 %>">First</a>
								<div>First</div></li>
							<li class="disable"><a
								href="tdmOnBoardingDashBoardCR?page=<%= currentPage-1 %>">&lt;
									Prev</a>
							...
							<%
			    						...
			    						%>
							<li><a href="tdmOnBoardingDashBoardCR?page=<%= i %>"
								id="employeeLink"></a>
								<div><%= i %></div></li>
							<%
			    									}
										...
										%>
							<li><a
								href="tdmOnBoardingDashBoardCR?page=<%= currentPage+1 %>">Next
									&gt;</a>
								<div>Next &gt;</div></li>
							<li><a href="tdmOnBoardingDashBoardCR?page=<%= noOfPages %>">Last</a>
								<div>Last</div></li>
							<%
											} else {
											    if(noOfPages > 1) {
							...
							<li class="disable"><a
								...
								<div>Next &gt;</div></li>
							<li class="disable"><a
								href="tdmOnBoardingDashBoardCR?page=<%= noOfPages %>">Last</a>
								<div>Last</div></li>
							<%
											    }
											}
