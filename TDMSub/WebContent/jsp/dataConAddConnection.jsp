          	 	...
          	 	<h2 style="color: #0098cc ;   padding-top: 5%;">Add Connection</h2>
          	 	  ...
          	 	  <form:hidden path="conId"/>
          	 	   <tbody>
                 	  ...
                 	  <tr>
                		<td class="lable-title" align="left" valign="middle">Connection Name<span>*</span></td>
                  		<td class="flied-title" align="left" valign="middle">
                    	   <form:input path="connectionName" id="connectionName" required="required"  class="form-control" autocomplete="off"/>
                  		</td>
                 	  </tr>
                	 <tr>
                 	  ...
                 	  <tr>
                		...
                		<td class="lable-title" align="left" valign="middle">Password<span>*</span></td>
                  		<td class="flied-title" align="left" valign="middle">
                    	   <form:password path="pass" id="pass" required="required" class="form-control" autocomplete="off" />
                  		</td>
                 	  </tr>
